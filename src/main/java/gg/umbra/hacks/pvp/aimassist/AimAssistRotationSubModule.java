...
extends SubHack<AutoAim> {
    ...
    private void computeTargetOffset() {
        Vec3d closestPoint = RotationUtil.T(Minecraft.thePlayer(), this.target.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl(), 0.0, 0.0, 0.0);
    ...
    public AimAssistRotationSubModule(HackModule parent, String name) {
        super(parent, name);
