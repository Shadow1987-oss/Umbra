...
import gg.umbra.tutorial.QueuedTutorialMessage;
import gg.umbra.tutorial.TutorialAction;
import gg.umbra.tutorial.TutorialActionComponent;
...
extends TutorialAction {
    ...
    @Override
    public void cleanup() {
        Umbra.debugLog("completed stage");
        for (GuiComponent guiComponent : this.highlightedComponents) {
            Umbra.debugLog("removed " + guiComponent + " " + this.mouseListeners.get(guiComponent));
    ...
    public void registerMouseListener(GuiComponent guiComponent, GuiMouseListener guiMouseListener) {
        Umbra.debugLog("adding listener " + guiComponent + " " + guiMouseListener);
