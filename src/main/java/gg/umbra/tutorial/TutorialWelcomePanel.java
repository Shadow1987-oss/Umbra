...
import gg.umbra.tutorial.TutorialWelcomeSkipAllClickHandler;
import gg.umbra.tutorial.TutorialWelcomeStartButton;
import gg.umbra.tutorial.TutorialWelcomeStartClickHandler;
...
import gg.umbra.ui.click.component.gui.UnderlinedTextLabel;
...
extends TutorialOverlayPanelBase {
    ...
    public TutorialWelcomePanel() {
        ...
        this.h(new WrappingTextLabelComponent("Thank you for choosing Umbra V4!\n \nIf you are new to Umbra, or clients in general, please proceed with the tutorial", 0.8, TutorialWelcomePanel.J.Z), "spanwidth, offsetY 30, offsetX 20");
