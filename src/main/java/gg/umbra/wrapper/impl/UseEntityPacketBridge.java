...
extends Packet {
    ...
    public int getEntityId() {
        return UseEntityPacketBridge.umbraInstance.getMappings().Co.getEntityId(this.I);
    }
    ...
    public Vec3 getHitLocation() {
        if (ForgeVersion.MC_26_1.d()) {
            ...
            Object hitLocation = UseEntityPacketBridge.umbraInstance.getMappings().Co.getHitLocation(this.I);
            return hitLocation == null ? EMPTY_HIT_LOCATION : new Vec3(hitLocation);
        }
        if (ForgeVersion.MC_1_20_6.d()) {
            CPacketUseEntityAction action = new CPacketUseEntityAction(UseEntityPacketBridge.umbraInstance.getMappings().Co.getAction(this.I), null);
        ...
        return new Vec3(UseEntityPacketBridge.umbraInstance.getMappings().Co.getHitLocation(this.I));
    }

    public void setEntityId(int entityId) {
        UseEntityPacketBridge.umbraInstance.getMappings().Co.setEntityId(this.I, entityId);
    }
    ...
    public CPacketUseEntity getAction() {
        ...
        return new CPacketUseEntity(UseEntityPacketBridge.umbraInstance.getMappings().Co.getAction(this.I), null);
    }
