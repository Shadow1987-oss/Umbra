...
import gg.umbra.wrapper.impl.PotionEntryBuilder;
import gg.umbra.wrapper.impl.PotionEntryResolveException;
...
public class PotionEntry {
    ...
    public void t(EntityLivingBase entityLivingBase, Object object, int n) {
        ...
        Umbra.INSTANCE.getMappings().qU.b(this.getResolvedObject(), entityLivingBase.getObject(), object, n);
    }
