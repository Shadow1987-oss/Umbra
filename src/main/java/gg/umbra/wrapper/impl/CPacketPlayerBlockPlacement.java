...
import gg.umbra.utils.MutableFloatTriple;
...
extends Wrapper {
    public float getFacingX() {
        ...
        return CPacketPlayerBlockPlacement.umbraInstance.getMappings().D3.getFacingX(this.getObject());
    }

    public Object getHand() {
        if (ForgeVersion.MC_1_16_5_ACTUAL.d()) {
            return CPacketPlayerBlockPlacement.umbraInstance.getMappings().D3.getHand(this.I);
        }
    ...
    public ItemStack getItemStack() {
        ...
        return new ItemStack(CPacketPlayerBlockPlacement.umbraInstance.getMappings().D3.getItemStack(this.I));
    }

    public BlockRayTraceResult getBlockHit() {
        if (ForgeVersion.MC_1_16_5_ACTUAL.d()) {
            return new BlockRayTraceResult(CPacketPlayerBlockPlacement.umbraInstance.getMappings().D3.getBlockHit(this.I));
        }
        throw new UnsupportedOperationException("Unimplemented");
    }
    ...
    public int getSequence() {
        if (ForgeVersion.MC_1_21_11.d()) {
            return CPacketPlayerBlockPlacement.umbraInstance.getMappings().D3.getSequence(this.I);
        }
        return -1;
    }
    ...
    public float getFacingZ() {
        ...
        return CPacketPlayerBlockPlacement.umbraInstance.getMappings().D3.getFacingZ(this.getObject());
    }
    ...
    public float getFacingY() {
        ...
        return CPacketPlayerBlockPlacement.umbraInstance.getMappings().D3.getFacingY(this.getObject());
    }
    ...
    public BlockPos getBlockPosition() {
        ...
        return new BlockPos(CPacketPlayerBlockPlacement.umbraInstance.getMappings().D3.getBlockPosition(this.getObject()));
    }
    ...
    public int getPlacedBlockDirection() {
        ...
        return CPacketPlayerBlockPlacement.umbraInstance.getMappings().D3.getPlacedBlockDirection(this.getObject());
    }
}
