...
extends Wrapper {
    public static float C(ItemStack itemStack, EnumCreatureAttribute enumCreatureAttribute) {
        ...
        return MEnchantmentHelper.w(EnchantmentHelper.umbraInstance.getMappings().Rk, itemStack.getObject(), object);
    }
    ...
    public static boolean Q(ItemStack itemStack) {
        return MEnchantmentHelper.z(EnchantmentHelper.umbraInstance.getMappings().Rk, itemStack.getObject());
    }
    ...
    public static EnchantmentModifierDamage getDamageModifier() {
        ...
        return new EnchantmentModifierDamage(MEnchantmentHelper.getDamageModifier(EnchantmentHelper.umbraInstance.getMappings().Rk));
    }
    ...
    public static void J(EnchantmentModifier enchantmentModifier, ItemStack[] itemStackArray) {
        if (ForgeVersion.MC_1_12_2.d()) {
            ...
            MEnchantmentHelper.T(EnchantmentHelper.umbraInstance.getMappings().Rk, enchantmentModifier.getObject(), arrayList);
            return;
        }
        ...
        MEnchantmentHelper.o(EnchantmentHelper.umbraInstance.getMappings().Rk, enchantmentModifier.getObject(), objectArray);
    }
    ...
    public static int q(int n, ItemStack itemStack) {
        ...
        if (ForgeVersion.MC_1_12_2.d()) {
            ...
            return MEnchantmentHelper.W(EnchantmentHelper.umbraInstance.getMappings().Rk, enchantment.getObject(), itemStack.getObject());
        }
        return MEnchantmentHelper.h(EnchantmentHelper.umbraInstance.getMappings().Rk, n, itemStack.getObject());
    }
    ...
    public static int e(String string, ItemStack itemStack) {
        ...
        return MEnchantmentHelper.X(EnchantmentHelper.umbraInstance.getMappings().Rk, optional.get().getObject(), itemStack.getObject());
    }
    ...
    public static int B(ItemStack[] itemStackArray, DamageSource damageSource) {
        ...
        if (ForgeVersion.MC_1_12_2.d()) {
            ...
            return MEnchantmentHelper.N(EnchantmentHelper.umbraInstance.getMappings().Rk, arrayList, damageSource.getObject());
        }
        Object[] objectArray = new Object[itemStackArray.length];
        for (int i = 0; i < itemStackArray.length; ++i) {
            objectArray[i] = itemStackArray[i].getObject();
        }
        return MEnchantmentHelper.p(EnchantmentHelper.umbraInstance.getMappings().Rk, objectArray, damageSource.getObject());
    }

    public static float N(Object object, ItemStack itemStack, Entity entity, DamageSource damageSource, float f) {
        return MEnchantmentHelper.F(EnchantmentHelper.umbraInstance.getMappings().Rk, object, itemStack.getObject(), entity.getObject(), damageSource.getObject(), f);
    }
    ...
    public static int q(Enchantment enchantment, ItemStack itemStack) {
        if (ForgeVersion.MC_1_21_4.d()) {
            ...
            return MEnchantmentHelper.X(EnchantmentHelper.umbraInstance.getMappings().Rk, holder.getObject(), itemStack.getObject());
        }
        return MEnchantmentHelper.X(EnchantmentHelper.umbraInstance.getMappings().Rk, enchantment.getObject(), itemStack.getObject());
    }
    ...
    public static int y(Entity entity) {
        ...
        return MEnchantmentHelper.a(EnchantmentHelper.umbraInstance.getMappings().Rk, entity.getObject());
    }

    public static PotionVersionRange m(ItemStack itemStack) {
        return new PotionVersionRange(MEnchantmentHelper.l(EnchantmentHelper.umbraInstance.getMappings().Rk, itemStack.getObject()));
    }
    ...
    public static int a(ResourceKey resourceKey, EntityLiving entityLiving) {
        ...
        arrayList.add(entityLiving.B$src$Lgg_umbra_wrapper_impl_ItemStack_$impdvt());
