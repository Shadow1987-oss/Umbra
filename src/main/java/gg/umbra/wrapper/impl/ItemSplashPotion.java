...
extends Item {
    ...
    public String getItemStackDisplayName(ItemStack itemStack) {
        if (ForgeVersion.MC_1_16_5.d()) {
            ITextComponent iTextComponent = new ITextComponent(MItemPotion.M(ItemSplashPotion.umbraInstance.getMappings().CI, this.I, itemStack.getObject()));
            return iTextComponent.getFormattedText();
        }
        return MItemPotion.B(ItemSplashPotion.umbraInstance.getMappings().CI, this.I, itemStack.getObject());
    }
    ...
    public List getRawPotionEffects(ItemStack itemStack) {
        ...
        return MItemPotion.R(ItemSplashPotion.umbraInstance.getMappings().CI, this.I, itemStack.getObject());
    }

    public List<PotionEffect> getPotionEffects(ItemStack itemStack) {
        ArrayList<PotionEffect> arrayList = new ArrayList<PotionEffect>();
        List list = ForgeVersion.MC_1_20_6.d() ? this.getRawPotionEffects(itemStack) : MItemPotion.R(ItemSplashPotion.umbraInstance.getMappings().CI, this.I, itemStack.getObject());
        for (Object e : list) {
    ...
    public List<PotionEffect> getPotionEffects(int n) {
        ArrayList<PotionEffect> arrayList = new ArrayList<PotionEffect>();
        List list = MItemPotion.R(ItemSplashPotion.umbraInstance.getMappings().CI, this.I, n);
        for (Object e : list) {
            arrayList.add(new PotionEffect(e));
        }
        return arrayList;
