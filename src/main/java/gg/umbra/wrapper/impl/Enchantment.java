...
extends Wrapper {
    ...
    public static Enchantment getEnchantmentById(int n) {
        if (ForgeVersion.MC_1_12_2.d() && ForgeVersion.MC_1_16_5.v()) {
            return new Enchantment(MEnchantment.k(Enchantment.umbraInstance.getMappings().RC, n));
        }
    ...
    public int getId() {
        ...
        if (ForgeVersion.MC_1_12_2.d()) {
            return MEnchantment.m(Enchantment.umbraInstance.getMappings().RC, this.I);
        }
        return MEnchantment.o(Enchantment.umbraInstance.getMappings().RC, this.I);
    }
    ...
    public static Enchantment[] getEnchantments() {
        ...
        if (ForgeVersion.MC_1_12_2.d()) {
            Iterable iterable = (Iterable)MEnchantment.N(Enchantment.umbraInstance.getMappings().RC);
        ...
        Object[] objectArray = MEnchantment.x(Enchantment.umbraInstance.getMappings().RC);
        if (objectArray == null) {
            return new Enchantment[0];
        }
    ...
    public String getTranslatedName(int n) {
        ...
        if (ForgeVersion.MC_1_21_0.d()) {
            ...
            ITextComponent iTextComponent = new ITextComponent(MEnchantment.O(Enchantment.umbraInstance.getMappings().RC, holder.getObject(), n));
            return iTextComponent.getFormattedText();
        }
        if (ForgeVersion.MC_1_16_5.d()) {
            ITextComponent iTextComponent = new ITextComponent(MEnchantment.J(Enchantment.umbraInstance.getMappings().RC, this.I, n));
            return iTextComponent.getFormattedText();
        }
        return MEnchantment.E(Enchantment.umbraInstance.getMappings().RC, this.I, n);
    }
