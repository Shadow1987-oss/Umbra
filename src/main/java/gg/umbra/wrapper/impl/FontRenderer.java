...
import gg.umbra.ui.font.StbSmoothFontRenderer;
...
extends Wrapper {
    ...
    public int B(String string, double d, double d2, int n, boolean bl, RenderMatrix4f renderMatrix4f, SharedMonsterAttributes sharedMonsterAttributes, GlScissorRect glScissorRect) {
        ...
        RenderItemFontBridge renderItemFontBridge = Minecraft.H$src$Lgg_umbra_wrapper_impl_VoxelShape_$1dlcquv().getBufferSource();
    ...
    public int getFontHeight() {
        return FontRenderer.umbraInstance.getMappings().R7.m(this.I);
    }
    ...
    public int H(MatrixStack matrixStack, String string, int n, int n2, int n3, boolean bl) {
        ...
        return FontRenderer.umbraInstance.getMappings().R7.C(renderItemTextBridge.getObject(), this.I, string, n, n2, n3, bl);
    }
    ...
    public int V(String string, double d, double d2, int n, MatrixStack matrixStack) {
        ...
        if (ForgeVersion.MC_1_16_5.d()) {
            int n2 = FontRenderer.umbraInstance.getMappings().R7.M(this.I, matrixStack.getObject(), string, (float)d, (float)d2, n);
            return n2;
        }
        if (ForgeVersion.MC_1_7_10.Y()) {
            return FontRenderer.umbraInstance.getMappings().R7.drawStringWithShadow(this.I, string, (float)d, (float)d2, n);
        }
        return FontRenderer.umbraInstance.getMappings().R7.d(this.I, string, (int)d, (int)d2, n);
    }
    ...
    public int Z(ITextComponent iTextComponent, float f, float f2, int n, boolean bl, Matrix4f matrix4f, RenderItemFontBridge renderItemFontBridge, boolean bl2, int n2, int n3) {
        return FontRenderer.umbraInstance.getMappings().R7.C(this.I, iTextComponent.getObject(), f, f2, n, bl, matrix4f.getObject(), renderItemFontBridge.getObject(), bl2, n2, n3);
    }
    ...
    public int p(String string, float f, float f2, int n, boolean bl, Matrix4f matrix4f, RenderItemFontBridge renderItemFontBridge, SharedMonsterAttributes sharedMonsterAttributes, int n2, int n3) {
        return MFontRenderer.i(FontRenderer.umbraInstance.getMappings().R7, this.I, string, f, f2, n, bl, matrix4f.getObject(), renderItemFontBridge.getObject(), sharedMonsterAttributes.getObject(), n2, n3);
    }
    ...
    public int A(String string, float f, float f2, int n, boolean bl, MatrixStack matrixStack, GlScissorRect glScissorRect) {
        ...
        return FontRenderer.umbraInstance.getMappings().R7.Y(this.I, string, f, f2, n, bl);
    }
    ...
    public int s(String string, double d, double d2, int n, boolean bl, MatrixStack matrixStack, GlScissorRect glScissorRect) {
        if (ForgeVersion.MC_1_20_6.d()) {
            return this.B(string, d, d2, n, bl, matrixStack.F().getMatrix().m$src$Lgg_umbra_utils_render_RenderMatrix4f_$1hodrum(), SharedMonsterAttributes.V(), glScissorRect);
        }
        if (ForgeVersion.MC_1_16_5.d()) {
            if (bl) {
                return FontRenderer.umbraInstance.getMappings().R7.M(this.I, matrixStack.getObject(), string, (float)d, (float)d2, n);
            }
            return FontRenderer.umbraInstance.getMappings().R7.S(this.I, matrixStack.getObject(), string, (float)d, (float)d2, n);
        }
        return FontRenderer.umbraInstance.getMappings().R7.u(this.I, string, (int)d, (int)d2, n);
    }
    ...
    public int getStringWidth(String string) {
        ...
        int n = FontRenderer.umbraInstance.getMappings().R7.e(this.I, string);
        this.H.put(string, n);
        return n;
    }
    ...
    public int h(String string, double d, double d2, int n, boolean bl, RenderMatrix4f renderMatrix4f, SharedMonsterAttributes sharedMonsterAttributes) {
        // Font.drawInBatch was removed in 26.2, so preserve the world transform in Umbra's glyph batch.
        if (ForgeVersion.MC_26_2.d()) {
            SmoothFontRenderer smoothFontRenderer = Umbra.INSTANCE.getFontManager().p(1.0);
    ...
    public void J(MatrixStack matrixStack, ITextComponent iTextComponent, float f, float f2, int n) {
        MFontRenderer.q(FontRenderer.umbraInstance.getMappings().R7, this.I, matrixStack.getObject(), iTextComponent.getObject(), f, f2, n);
    }
    ...
    public void r() {
        FontRenderer.umbraInstance.getMappings().R7.J(this.I);
    }
    ...
    public void U(MatrixStack matrixStack, ITextComponent iTextComponent, float f, float f2, int n) {
        MFontRenderer.A(FontRenderer.umbraInstance.getMappings().R7, this.I, matrixStack.getObject(), iTextComponent.getObject(), f, f2, n);
    }
