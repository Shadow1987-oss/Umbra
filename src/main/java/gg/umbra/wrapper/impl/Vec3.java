...
extends Wrapper {
    ...
    public static final Vec3 H() {
        if (v == null) {
            v = new Vec3(Vec3.umbraInstance.getMappings().g.O());
        }
        return v;
    }

    public Vec3 r(double d) {
        return new Vec3(Vec3.umbraInstance.getMappings().g.H(this.I, d));
    }
    ...
    public double getY() {
        return Vec3.umbraInstance.getMappings().g.z(this.I);
    }

    public void N(double d) {
        Vec3.umbraInstance.getMappings().g.V(this.I, d);
    }
    ...
    public Vec3 addVector(double d, double d2, double d3) {
        return new Vec3(Vec3.umbraInstance.getMappings().g.Y(this.I, d, d2, d3));
    }
    ...
    public void Z(double d) {
        Vec3.umbraInstance.getMappings().g.Z(this.I, d);
    }

    public double distanceTo(Vec3 vec3) {
        return Vec3.umbraInstance.getMappings().g.S(this.I, vec3.getObject());
    }
    ...
    public void m(double d) {
        Vec3.umbraInstance.getMappings().g.K(this.I, d);
    }
    ...
    public double getZ() {
        return Vec3.umbraInstance.getMappings().g.P(this.I);
    }
    ...
    public Vec3 i(Object object, double d) {
        return new Vec3(Vec3.umbraInstance.getMappings().g.M(this.I, object, d));
    }
    ...
    public double getX() {
        return Vec3.umbraInstance.getMappings().g.O(this.I);
    }
    ...
    public static Vec3 create(double d, double d2, double d3) {
        return new Vec3(Vec3.umbraInstance.getMappings().g.q(d, d2, d3));
    }
}
