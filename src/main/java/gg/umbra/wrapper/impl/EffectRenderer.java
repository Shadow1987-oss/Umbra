...
extends Wrapper {
    ...
    public List<SoundAwareEntityFX> getParticleEmitters() {
        List list = EffectRenderer.umbraInstance.getMappings().Ru.A(this.I);
    ...
    public List<EntityFX>[][] getFxLayers() {
        if (ForgeVersion.MC_1_7_10.Y()) {
            List[][] listArray = MEffectRenderer.N(EffectRenderer.umbraInstance.getMappings().Ru, this.I);
        ...
        List[] listArray = MEffectRenderer.z(EffectRenderer.umbraInstance.getMappings().Ru, this.I);
        int n = 0;
