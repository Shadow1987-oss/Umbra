...
extends Wrapper {
    public static Quaternion fromAxisAngle(Vector3f axis, float angle, boolean degrees) {
        ...
        return new Quaternion(Quaternion.umbraInstance.getMappingsMapperCompat().quaternion.newFromComponents(x, y, z, w));
    }

    public float getZ() {
        return Quaternion.umbraInstance.getMappingsMapperCompat().quaternion.getZ(this.I);
    }
    ...
    public static Quaternion fromEulerAngles(float xAngle, float yAngle, float zAngle, boolean degrees) {
        ...
        return new Quaternion(Quaternion.umbraInstance.getMappingsMapperCompat().quaternion.newFromEulerAngles(xAngle, yAngle, zAngle, degrees));
    }

    public float getX() {
        return Quaternion.umbraInstance.getMappingsMapperCompat().quaternion.getX(this.I);
    }

    public float getW() {
        return Quaternion.umbraInstance.getMappingsMapperCompat().quaternion.getW(this.I);
    }
    ...
    public float getY() {
        return Quaternion.umbraInstance.getMappingsMapperCompat().quaternion.getY(this.I);
    }
}
