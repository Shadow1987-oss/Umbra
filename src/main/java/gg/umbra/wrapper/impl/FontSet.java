...
extends Wrapper {
    ...
    public FontGlyph getMissingGlyph() {
        Object glyphHandle = FontSet.umbraInstance.getMappingsMapperCompat().fontSet.getMissingGlyph(this.I);
    ...
    public GlyphProvider getGlyphSource(boolean filterFishyGlyphs) {
        return new GlyphProvider(FontSet.umbraInstance.getMappingsMapperCompat().fontSet.getSource(this.I, filterFishyGlyphs));
    }
