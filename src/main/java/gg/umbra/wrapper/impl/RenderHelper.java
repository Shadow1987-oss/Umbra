...
extends Wrapper {
    ...
    public static void s() {
        ...
        MRenderHelper.L(RenderHelper.umbraInstance.getMappingsMapperCompat().x);
    }

    public static void l() {
        if (ForgeVersion.MC_1_17.d()) {
            MRenderHelper.M(RenderHelper.umbraInstance.getMappingsMapperCompat().x);
            return;
        }
    ...
    public static void e() {
        ...
        MRenderHelper.Q(RenderHelper.umbraInstance.getMappingsMapperCompat().x);
    }
}
