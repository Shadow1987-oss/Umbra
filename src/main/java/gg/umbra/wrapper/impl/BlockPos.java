...
extends Vec3i {
    ...
    public BlockPos y() {
        return new BlockPos(MBlockPos.s(BlockPos.umbraInstance.getMappings().RP, this.I));
    }
    ...
    public BlockPos X$src$Lgg_umbra_wrapper_impl_BlockPos_$jlnp6b() {
        return new BlockPos(MBlockPos.B(BlockPos.umbraInstance.getMappings().RP, this.I));
    }
    ...
    public static BlockPos P(Vec3 vec3) {
        ...
        return new BlockPos(BlockPos.umbraInstance.getMappings().RP.D(vec3.getObject()));
    }
    ...
    public BlockPos j() {
        return new BlockPos(MBlockPos.O(BlockPos.umbraInstance.getMappings().RP, this.I));
    }

    public BlockPos g(EnumFacing enumFacing, int n) {
        return new BlockPos(BlockPos.umbraInstance.getMappings().RP.offset(this.I, enumFacing.getObject(), n));
    }
    ...
    public static BlockPos D(double d, double d2, double d3) {
        ...
        return new BlockPos(BlockPos.umbraInstance.getMappings().RP.H(d, d2, d3));
    }
    ...
    public BlockPos d$src$Lgg_umbra_wrapper_impl_BlockPos_$6vry9r() {
        return new BlockPos(MBlockPos.z(BlockPos.umbraInstance.getMappings().RP, this.I));
    }

    public BlockPos o$src$Lgg_umbra_wrapper_impl_BlockPos_$10np7re() {
        return new BlockPos(MBlockPos.H(BlockPos.umbraInstance.getMappings().RP, this.I));
    }

    public static BlockPos create(int n, int n2, int n3) {
        return new BlockPos(BlockPos.umbraInstance.getMappings().RP.q(n, n2, n3));
    }
}
