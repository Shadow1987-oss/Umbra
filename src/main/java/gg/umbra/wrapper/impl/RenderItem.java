...
extends Wrapper {
    ...
    public static RenderItem d() {
        if (h == null && MRenderItem.V(RenderItem.umbraInstance.getMappings().DI) == null && ForgeVersion.MC_1_7_10.L() && isNativeAvailable) {
            h = MRenderItem.F(RenderItem.umbraInstance.getMappings().DI).newInstance(new Object[0]);
        }
        return new RenderItem(h != null ? h : MRenderItem.a(RenderItem.umbraInstance.getMappings().DI));
    }

    public void z(float f) {
        MRenderItem.l(RenderItem.umbraInstance.getMappings().DI, this.I, f);
    }
    ...
    public float b() {
        return MRenderItem.I(RenderItem.umbraInstance.getMappings().DI, this.I);
    }
    ...
    public void I(ItemStack itemStack, RenderItemContext renderItemContext, boolean bl, MatrixStack matrixStack, RenderItemFontBridge renderItemFontBridge, int n, int n2, Channel bakedModel) {
        MRenderItem.x(RenderItem.umbraInstance.getMappings().DI, this.I, itemStack.getObject(), renderItemContext.getObject(), bl, matrixStack.getObject(), renderItemFontBridge.getObject(), n, n2, bakedModel.getObject());
    }
    ...
    public void e(float f) {
        ...
        MRenderItem.G(RenderItem.umbraInstance.getMappings().DI, this.I, f);
    }
    ...
    public Channel getBakedModel(ItemStack itemStack, World world, Object entityHandle, int seed) {
        ...
        return new Channel(MRenderItem.A(RenderItem.umbraInstance.getMappings().DI, this.I, itemStack.getObject(), worldHandle, entityHandle, seed));
    }

    public void c(FontRenderer fontRenderer, TextureManager textureManager, ItemStack itemStack, int n, int n2) {
        if (ForgeVersion.MC_1_7_10.L()) {
            MRenderItem.z(RenderItem.umbraInstance.getMappings().DI, this.I, fontRenderer.getObject(), textureManager.getObject(), itemStack.getObject(), n, n2);
            ...
            RenderItem.umbraInstance.getMappings().DI.M(this.I, itemStack.getObject(), n, n2);
        }
    }
    ...
    public float T() {
        ...
        return MRenderItem.x(RenderItem.umbraInstance.getMappings().DI, this.I);
    }

    public void o(RenderItemTextBridge renderItemTextBridge, ItemStack itemStack, int n, int n2) {
        RenderItem.umbraInstance.getMappings().DI.M(renderItemTextBridge.getObject(), itemStack.getObject(), n, n2);
    }

    public void P(FontRenderer fontRenderer, TextureManager textureManager, ItemStack itemStack, int n, int n2) {
        if (ForgeVersion.MC_1_7_10.L()) {
            MRenderItem.P(RenderItem.umbraInstance.getMappings().DI, this.I, fontRenderer.getObject(), textureManager.getObject(), itemStack.getObject(), n, n2);
        } else {
            MRenderItem.Y(RenderItem.umbraInstance.getMappings().DI, this.I, fontRenderer.getObject(), itemStack.getObject(), n, n2);
        }
    }
