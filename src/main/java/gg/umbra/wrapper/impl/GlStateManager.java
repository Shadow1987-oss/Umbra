...
extends Wrapper {
    ...
    public static void disableTexture2D() {
        ...
        MGlStateManager.a(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static int F() {
        ...
        return MGlStateManager.A(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void L() {
        ...
        MGlStateManager.c(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void setActiveTexture(int n) {
        ...
        MGlStateManager.m(GlStateManager.umbraInstance.getMappings().Dt, n);
    }
    ...
    public static GlStateManager_BlendState W() {
        if (F == null) {
            F = new GlStateManager_BlendState(MGlStateManager.U(GlStateManager.umbraInstance.getMappings().Dt));
        }
        return F;
    }
    ...
    public static void tryBlendFuncSeparate(int n, int n2, int n3, int n4) {
        ...
        MGlStateManager.B(GlStateManager.umbraInstance.getMappings().Dt, n, n2, n3, n4);
    }
    ...
    public static void enableTexture2D() {
        ...
        MGlStateManager.Z(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void F$src$V$acq27m() {
        ...
        MGlStateManager.P(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void Y() {
        ...
        MGlStateManager.N(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void depthMask(boolean bl) {
        ...
        MGlStateManager.p(GlStateManager.umbraInstance.getMappings().Dt, bl);
    }
    ...
    public static void enableDepth() {
        ...
        MGlStateManager.M(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void bindTexture(int n) {
        ...
        if (activeTextureState == null && (objectArray = MGlStateManager.e(GlStateManager.umbraInstance.getMappings().Dt)) != null && objectArray.length > 0 && (object = objectArray[0]) != null) {
    ...
    public static void disableDepth() {
        ...
        MGlStateManager.j(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void color(float f, float f2, float f3, float f4) {
        ...
        if (ForgeVersion.MC_1_17.d()) {
            MGlStateManager.Z(GlStateManager.umbraInstance.getMappings().Dt, f == 1.0f, f2 == 1.0f, f3 == 1.0f, f4 == 1.0f);
            return;
        }
        MGlStateManager.O(GlStateManager.umbraInstance.getMappings().Dt, f, f2, f3, f4);
    }
    ...
    public static void g(float f) {
        ...
        MGlStateManager.c(GlStateManager.umbraInstance.getMappings().Dt, f);
    }
    ...
    public static void d(float f, float f2, float f3, float f4) {
        ...
        MGlStateManager.P(GlStateManager.umbraInstance.getMappings().Dt, f, f2, f3, f4);
    }
    ...
    public static void Y(int n, int n2) {
        ...
        MGlStateManager.j(GlStateManager.umbraInstance.getMappings().Dt, n, n2);
    }
    ...
    public static int i(int n) {
        ...
        return GlStateManager.umbraInstance.getMappings().Dt.w(n);
    }
    ...
    public static void t(int n, int n2) {
        ...
        MGlStateManager.a(GlStateManager.umbraInstance.getMappings().Dt, n, n2);
    }
    ...
    public static void disableLighting() {
        ...
        MGlStateManager.X(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void enableAlpha() {
        ...
        MGlStateManager.v(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void disableAlpha() {
        ...
        MGlStateManager.O(GlStateManager.umbraInstance.getMappings().Dt);
    }
    ...
    public static void h(int n, int n2, int n3, int n4, int n5, int n6, int n7, int n8, IntBuffer intBuffer) {
        MGlStateManager.Q(GlStateManager.umbraInstance.getMappings().Dt, n, n2, n3, n4, n5, n6, n7, n8, intBuffer);
    }
    ...
    public static ArrayList<GlStateManager$TextureState> R() {
        ...
        for (Object object : MGlStateManager.e(GlStateManager.umbraInstance.getMappings().Dt)) {
