...
extends Wrapper {
    ...
    public static Vec3i create(int x, int y, int z) {
        return new Vec3i(MVec3I.getConstructor(Vec3i.umbraInstance.getMappings().vec3i).newInstance(x, y, z));
    }
    ...
    public int getY() {
        return Vec3i.umbraInstance.getMappings().vec3i.getY(this.I);
    }

    public int getZ() {
        return Vec3i.umbraInstance.getMappings().vec3i.getZ(this.I);
    }
    ...
    public int getX() {
        return Vec3i.umbraInstance.getMappings().vec3i.getX(this.I);
    }
