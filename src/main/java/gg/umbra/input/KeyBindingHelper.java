...
import gg.umbra.utils.AxisAlignedBBDistanceComparator;
...
public class KeyBindingHelper {
    ...
    public static BlockData findSupportingBlock() {
        ...
        if (ForgeVersion.MC_1_8_9.d()) {
            playerBounds = player.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl();
        } else {
            AxisAlignedBB currentBounds = player.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl();
