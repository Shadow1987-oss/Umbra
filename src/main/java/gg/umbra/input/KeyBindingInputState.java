...
public class KeyBindingInputState {
    ...
    public static void pressUseKey(boolean usePostMessage) {
        KeyBindingInputState.pressKeyBinding(Minecraft.gameSettings().b$src$Lgg_umbra_wrapper_impl_KeyBinding_$1yi3362(), usePostMessage);
    }
    ...
    public static void releaseUseKey(boolean usePostMessage) {
        KeyBindingInputState.releaseKeyBinding(Minecraft.gameSettings().b$src$Lgg_umbra_wrapper_impl_KeyBinding_$1yi3362(), usePostMessage);
    }
}
