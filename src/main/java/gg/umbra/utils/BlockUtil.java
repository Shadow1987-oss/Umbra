...
import gg.umbra.wrapper.impl.BlockReaderBridge;
import gg.umbra.wrapper.impl.BlockState;
import gg.umbra.wrapper.impl.Blocks;
import gg.umbra.wrapper.impl.Chunk;
import gg.umbra.wrapper.impl.ChunkSection;
import gg.umbra.wrapper.impl.EntityFishHook;
import gg.umbra.wrapper.impl.EntityPlayerSP;
import gg.umbra.wrapper.impl.ForgeVersion;
import gg.umbra.wrapper.impl.Item;
import gg.umbra.wrapper.impl.ItemBlock;
...
public class BlockUtil {
    ...
    public static boolean e(EntityPlayerSP entityPlayerSP, BlockData blockData) {
        AxisAlignedBB axisAlignedBB = entityPlayerSP.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().expand(0.01, 0.0, 0.01);
            ...
            if (ForgeVersion.MC_1_7_10.B()) {
                ...
                if (ForgeVersion.MC_1_16_5.d()) {
                    ...
                    if (blockState.isInstance(MappedClasses.Fj)) {
                        ...
                        EntityFishHook entityFishHook = blockReaderBridge.getShape(Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().l().x$src$Lgg_umbra_wrapper_impl_BlockReader_$120g8sh(), blockPos);
    ...
    public static int E() {
        Block block = Minecraft.p$src$Lgg_umbra_wrapper_impl_RayTraceResult_$5rw6n0().Z$src$Lgg_umbra_wrapper_impl_Block_$6x2c9a();
        if (block.isNull()) {
            return -1;
        }
