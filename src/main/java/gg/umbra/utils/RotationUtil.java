...
import gg.umbra.utils.FastAtanMath;
...
import gg.umbra.wrapper.impl.AttributeInstance;
...
import gg.umbra.wrapper.impl.MonsterAttributesBridge;
...
public class RotationUtil {
    ...
    public static boolean x() {
        ...
        return gameSettings.x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg().isKeyDown() || gameSettings.g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3().isKeyDown() || gameSettings.Y().isKeyDown() || gameSettings.s().isKeyDown();
    }
    ...
    public static ItemStack Z() {
        ...
        if (ForgeVersion.MC_1_20_6.d()) {
            return entityPlayerSP.F$src$Lgg_umbra_wrapper_impl_Container_$152y6lm().getCarried();
        }
        return entityPlayerSP.V$src$Lgg_umbra_wrapper_impl_InventoryPlayer_$erqak6().A();
    }
    ...
    public static EntityOtherPlayerMP m(Entity entity, double d, double d2, boolean bl) {
        for (Object e : Minecraft.theWorld().X()) {
            ...
            if (!MappedClasses.lG.isInstance(e) || (entityOtherPlayerMP = new EntityOtherPlayerMP(e)).equals(entity) || bl && Umbra.INSTANCE.getFriendManager().isFriend(entityOtherPlayerMP) || (double)entityOtherPlayerMP.getDistanceToEntity(entity) >= d || !((double)RotationUtil.a(entity, entityOtherPlayerMP) < d2)) continue;
    ...
    public static float b(EntityLivingBase entityLivingBase) {
        EntityPlayerSP entityPlayerSP = Minecraft.thePlayer();
        ItemStack itemStack = entityLivingBase.B$src$Lgg_umbra_wrapper_impl_ItemStack_$impdvt();
    ...
    public static void w() {
        GameSettings gameSettings = Minecraft.gameSettings();
        KeyBinding keyBinding = gameSettings.x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg();
        KeyBinding keyBinding2 = gameSettings.g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3();
        KeyBinding keyBinding3 = gameSettings.Y();
        KeyBinding keyBinding4 = gameSettings.s();
        KeyBinding keyBinding5 = gameSettings.r();
        KeyBinding keyBinding6 = gameSettings.d$src$Lgg_umbra_wrapper_impl_KeyBinding_$adn2z0();
        KeyBinding keyBinding7 = gameSettings.O();
        boolean bl = ClientSettings.isPhysicalKeyDown(gameSettings.x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg());
        boolean bl2 = ClientSettings.isPhysicalKeyDown(gameSettings.g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3());
        ...
        boolean bl6 = ClientSettings.isPhysicalKeyDown(gameSettings.d$src$Lgg_umbra_wrapper_impl_KeyBinding_$adn2z0());
    ...
    public static boolean k(EntityLivingBase entityLivingBase) {
        ...
        if (MappedClasses.Yl.isInstance(entityLivingBase)) {
            ...
            boolean bl = false;
            for (Object object : entityPlayer.V$src$Lgg_umbra_wrapper_impl_InventoryPlayer_$erqak6().i()) {
                ItemStack itemStack = new ItemStack(object);
                if (itemStack.isNull()) continue;
                bl = true;
            }
            return entityLivingBase.J$src$Z$fdev5g() && entityLivingBase.B$src$Lgg_umbra_wrapper_impl_ItemStack_$impdvt().isNull() && !bl;
        }
        return entityLivingBase.J$src$Z$fdev5g() && entityLivingBase.B$src$Lgg_umbra_wrapper_impl_ItemStack_$impdvt().isNull();
    }
    ...
    public static int N(EntityPlayer entityPlayer) {
        ...
        if (ClientSettings.IS_LEGACY_1_7) {
            ...
            for (Object e : list) {
                ...
                if (!playerInfo.v().isNotNull() || !entityPlayer.c$src$Lgg_umbra_wrapper_impl_GameProfile_$ir8937().equals(playerInfo.v()) && !entityPlayer.getName().equals(playerInfo.v().getName())) continue;
    ...
    public static EntityLivingBase K(double d, float f, float f2, float f3) {
        if (Minecraft.F().getObject() != null && Minecraft.theWorld().getObject() != null) {
            ...
            EntityOtherPlayerMP entityOtherPlayerMP = EntityOtherPlayerMP.create(entityLivingBase.getWorld(), Minecraft.thePlayer().c$src$Lgg_umbra_wrapper_impl_GameProfile_$ir8937());
    ...
    public static double h(Entity entity, double d, double d2, double d3) {
        ...
        if (ForgeVersion.MC_1_7_10.Y()) {
            d6 = entity.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().getMinY() + 1.6 - d2;
        }
    ...
    public static EntityLivingBase L(Entity entity, double d, double d2, boolean bl) {
        for (Object e : Minecraft.theWorld().z()) {
            ...
            if (!MappedClasses.zm.isInstance(e) || (entityLivingBase = new EntityLivingBase(e)).equals(entity) || entityLivingBase.M$src$Z$ff28xj() || entityLivingBase.w$src$F$15l9epb() <= 0.0f || bl && Umbra.INSTANCE.getFriendManager().isFriend(entityLivingBase) || (double)entityLivingBase.getDistanceToEntity(entity) >= d || !((double)RotationUtil.a(entity, entityLivingBase) < d2)) continue;
    ...
    public static boolean o(Entity entity, EntityLivingBase entityLivingBase, double d, double d2, boolean bl) {
        if (bl && Umbra.INSTANCE.getFriendManager().isFriend(entityLivingBase)) {
            return false;
        }
    ...
    public static boolean b$src$Z$reqs95(EntityLivingBase entityLivingBase) {
        ...
        if (entityLivingBase.isInstance(MappedClasses.Yl)) {
            ...
            return entityLivingBase.B$src$Lgg_umbra_wrapper_impl_ItemStack_$impdvt().isNull() && !bl;
        }
        return false;
    }
    ...
    public static EntityLivingBase b(double d, float f, EntityLivingBase entityLivingBase, EntityLivingBase entityLivingBase2) {
        ...
        if (Minecraft.F().getObject() != null && Minecraft.theWorld().getObject() != null) {
            ...
            float f2 = 1.0f;
            List list = Minecraft.theWorld().F(entityLivingBase, entityLivingBase.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().addCoord(vec32.getX() * d2, vec32.getY() * d2, vec32.getZ() * d2).expand(f2, f2, f2));
            double d4 = d3;
            for (int i = 0; i < list.size(); ++i) {
                ...
                float f3 = entity.b() + f;
                AxisAlignedBB axisAlignedBB = entity.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().expand(f3, f3, f3);
                ...
                if (entity.getObject() == entityLivingBase.S$src$Lgg_umbra_wrapper_impl_Entity_$dgzs12().getObject() && !entity.C$src$Z$f9kazx()) {
                    if (d4 != 0.0) continue;
                    wrapper = entity;
                    continue;
                }
            ...
            if (wrapper != null && (d4 < d3 || Minecraft.p$src$Lgg_umbra_wrapper_impl_RayTraceResult_$5rw6n0().getObject() == null) && Minecraft.thePlayer().canEntityBeSeen((Entity)wrapper) && MappedClasses.zm.isInstance(wrapper.getObject()) && !(entityLivingBase3 = new EntityLivingBase(wrapper.getObject())).M$src$Z$ff28xj()) {
    ...
    public static int a(Entity entity, int n, boolean bl) {
        ...
        for (Object e : Minecraft.theWorld().X()) {
            ...
            if (bl && Umbra.INSTANCE.getFriendManager().isFriend(entityOtherPlayerMP) || !(entityOtherPlayerMP.getDistanceToEntity(entity) <= (float)n)) continue;
            ++n2;
        }
        return n2;
    }
    ...
    public static EntityLivingBase u(double d, double d2) {
        ...
        for (Object e : Minecraft.theWorld().z()) {
            EntityLivingBase entityLivingBase;
            if (!MappedClasses.zm.isInstance(e) || !(entityLivingBase = new EntityLivingBase(e)).isInstance(MappedClasses.lG) || entityLivingBase.M$src$Z$ff28xj() || entityLivingBase.w$src$F$15l9epb() <= 0.0f || (double)entityLivingBase.getDistanceToEntity(entityPlayerSP) >= d || !Umbra.INSTANCE.getClientSettings().isValidTarget(entityLivingBase, false) || !((double)RotationUtil.N(entityLivingBase) < d2)) continue;
            return entityLivingBase;
        }
        return null;
    }
