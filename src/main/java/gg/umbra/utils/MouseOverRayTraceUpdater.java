...
public class MouseOverRayTraceUpdater {
    ...
    private static void M(float f, float f2) {
        ...
        if (entityLivingBase.isNotNull()) {
            ...
            d = f;
            d2 *= d2;
            if (Minecraft.p$src$Lgg_umbra_wrapper_impl_RayTraceResult_$5rw6n0().isNotNull()) {
                double d3;
            ...
            if (entityRayTraceResult.isNotNull()) {
                ...
                } else if (d5 < d2 || Minecraft.p$src$Lgg_umbra_wrapper_impl_RayTraceResult_$5rw6n0().isNull()) {
    ...
    private static void j(double d, float f) {
        ...
        if (entityLivingBase.isNotNull() && worldClient.isNotNull()) {
            ...
            Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().setPointedEntity(entity);
            Vec3 vec34 = null;
            float f3 = 1.0f;
            List list = worldClient.F(entityLivingBase, entityLivingBase.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().addCoord(vec32.getX() * d2, vec32.getY() * d2, vec32.getZ() * d2).expand(f3, f3, f3));
            double d4 = d3;
            for (int i = 0; i < list.size(); ++i) {
                ...
                AxisAlignedBB axisAlignedBB = ((Entity)wrapper).R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().expand(f4, f4, f4);
                RayTraceResult rayTraceResult2 = axisAlignedBB.calculateIntercept(vec3, vec33);
                if (axisAlignedBB.isVecInside(vec3)) {
                    if (!(0.0 < d4) && d4 != 0.0) continue;
                    Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().setPointedEntity((Entity)wrapper);
                ...
                if (wrapper.equals(entityLivingBase.S$src$Lgg_umbra_wrapper_impl_Entity_$dgzs12()) && !((Entity)wrapper).C$src$Z$f9kazx()) {
                    if (d4 != 0.0) continue;
                    Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().setPointedEntity((Entity)wrapper);
            ...
            Entity entity2 = Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().getPointedEntity();
            if (ForgeVersion.MC_1_7_10.Y() && entity2.isNotNull() && bl && vec3.distanceTo(vec34) > d) {
                ...
                entity2 = Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().getPointedEntity();
            }
            if (entity2.isNotNull() && (d4 < d3 || Minecraft.p$src$Lgg_umbra_wrapper_impl_RayTraceResult_$5rw6n0().isNull())) {
    ...
    public static EntityRayTraceResult o(Entity entity, Vec3 vec3, Vec3 vec32, AxisAlignedBB axisAlignedBB, double d, double d2, @Nullable Predicate<Entity> predicate) {
        ...
        while (iterator.hasNext()) {
            ...
            AxisAlignedBB axisAlignedBB2 = entity3.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().I((double)entity3.b() + d2);
            ...
            if (entity3.q$src$Lgg_umbra_wrapper_impl_Entity_$1ujnemc().equals(entity.q$src$Lgg_umbra_wrapper_impl_Entity_$1ujnemc())) {
                if (d3 != 0.0) continue;
                entity2 = new Entity(entity3);
    ...
    public static void b(boolean bl) {
        if (t == null) {
            t = Umbra.INSTANCE.getHackManager().getMod(Reach.class);
            s = Umbra.INSTANCE.getHackManager().getMod(HitBoxes.class);
        }
