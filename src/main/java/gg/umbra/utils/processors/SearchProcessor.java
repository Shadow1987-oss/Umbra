package gg.umbra.utils.processors;
...
implements Runnable {
    ...
    public SearchProcessor(List<SearchResultData> list, List<SearchBlock> list2, SliderSetting numberValue) {
