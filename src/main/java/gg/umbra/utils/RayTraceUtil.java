...
import gg.umbra.wrapper.impl.BlockRayTraceResult;
import gg.umbra.wrapper.impl.DataComponents;
import gg.umbra.wrapper.impl.Direction;
...
import gg.umbra.wrapper.impl.EntityRayTraceBridge;
import gg.umbra.wrapper.impl.EntityRayTraceResult;
...
public class RayTraceUtil {
    public static RayTraceResult b(Vec3 vec3, Vec3 vec32, World world, Entity entity, boolean bl, boolean bl2, boolean bl3, @Nullable Predicate<Entity> predicate) {
        ...
        AxisAlignedBB axisAlignedBB = entity.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().addCoord(d4, d5, d6);
        ...
        for (Object e : list) {
            ...
            float f2 = entity2.b();
            AxisAlignedBB axisAlignedBB2 = entity2.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().expand(f2, f2, f2);
            ...
            if (entity2.equals(entity.S$src$Lgg_umbra_wrapper_impl_Entity_$dgzs12()) && !entity2.C$src$Z$f9kazx()) {
                if (d7 != 0.0) continue;
                wrapper = entity2;
    ...
    private static RayTraceResult l(EntityLivingBase entityLivingBase, float f, @Nullable Predicate<Entity> predicate) {
        ...
        ItemStack itemStack = Minecraft.thePlayer().Y$src$Lgg_umbra_wrapper_impl_ItemStack_$1e6807m();
        if (itemStack.isNull()) {
            return null;
        }
    ...
    private static RayTraceResult y(EntityLivingBase entityLivingBase, float f, float f2, boolean bl, @Nullable Predicate<Entity> predicate) {
        ...
        if (entityLivingBase.isNotNull()) {
            ...
            double d4 = 1.0;
            AxisAlignedBB axisAlignedBB = entityLivingBase.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().c(vec32.r(d)).z(d4, d4, d4);
    ...
    public static EntityLivingBase l(EntityLivingBase entityLivingBase, double d, double d2) {
        ...
        float f3 = 1.0f;
        List list = worldClient.F(entityLivingBase, entityLivingBase.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().addCoord(vec32.getX() * (double)f2, vec32.getY() * (double)f2, vec32.getZ() * (double)f2).expand(f3, f3, f3));
        double d4 = d3;
        EntityPlayerSP entityPlayerSP = Minecraft.thePlayer();
        ...
        for (Object e : list) {
            ...
            AxisAlignedBB axisAlignedBB = entityLivingBase2.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().expand(f5, f5, f5).addCoord(entityLivingBase2.t(), entityLivingBase2.q(), entityLivingBase2.T());
            ...
            if (entityLivingBase2.equals(entityLivingBase.S$src$Lgg_umbra_wrapper_impl_Entity_$dgzs12()) && !entityLivingBase2.C$src$Z$f9kazx()) {
                if (d4 != 0.0) continue;
                entityLivingBase3 = entityLivingBase2;
                continue;
            }
    ...
    private static RayTraceResult m(EntityLivingBase entityLivingBase, float f, float f2, boolean bl, @Nullable Predicate<Entity> predicate) {
        ...
        if (entityLivingBase.isNotNull()) {
            ...
            if ((entityRayTraceResult = MouseOverRayTraceUpdater.o(entityLivingBase, vec33, vec32 = vec33.addVector((vec3 = entityLivingBase.J(f3)).getX() * d3, vec3.getY() * d3, vec3.getZ() * d3), axisAlignedBB = entityLivingBase.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().c(vec3.r(d3)).z(1.0, 1.0, 1.0), d4, f2, predicate)).isNotNull() && entityRayTraceResult.getHitVec().A(vec33) < d5) {
    ...
    public static RayTraceResult U(EntityLivingBase entityLivingBase, double d, float f, boolean bl, @Nullable Predicate<Entity> predicate) {
        ...
        if (entityLivingBase.isNotNull() && worldClient.isNotNull()) {
            ...
            Vec3 vec34 = null;
            float f3 = 1.0f;
            List list = worldClient.F(entityLivingBase, entityLivingBase.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().addCoord(vec32.getX() * d5, vec32.getY() * d5, vec32.getZ() * d5).expand(1.0, 1.0, 1.0));
            double d6 = d3;
            EntityPlayerSP entityPlayerSP = Minecraft.thePlayer();
            for (Object e : list) {
                double d7;
                ...
                float f4 = entity.b() + f;
                AxisAlignedBB axisAlignedBB = entity.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().expand(f4, f4, f4);
                ...
                if (entity.equals(entityLivingBase.S$src$Lgg_umbra_wrapper_impl_Entity_$dgzs12()) && !entity.C$src$Z$f9kazx()) {
                    if (d6 != 0.0) continue;
                    wrapper = entity;
