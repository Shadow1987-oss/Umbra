...
public class RenderBatchState {
    ...
    public void cleanup() {
        ...
        Umbra.debugLog("InstancedBlockRenderer cleaned up");
    }
    ...
    public void render(RenderMatrix4f projectionMatrix, RenderMatrix4f viewMatrix, RenderMatrix4f modelMatrix) {
        ...
        if (cullFaceEnabled = GL11.glIsEnabled((int)2884)) {
            ...
            gg.umbra.wrapper.impl.GL20.w(shaderProgram.projectionUniformLocation, false, projectionBuffer);
            gg.umbra.wrapper.impl.GL20.w(shaderProgram.viewUniformLocation, false, viewBuffer);
            gg.umbra.wrapper.impl.GL20.w(shaderProgram.modelUniformLocation, false, modelBuffer);
    ...
    private void initialize() {
        ...
        Umbra.debugLog("InstancedBlockRenderer initialized (capacity: " + this.instanceCapacity + " blocks)");
    }
