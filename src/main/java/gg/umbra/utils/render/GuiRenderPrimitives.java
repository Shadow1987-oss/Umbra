...
import gg.umbra.utils.render.LegacyFontShaderProgram;
...
import gg.umbra.utils.render.shader.ArcShaderProgram;
import gg.umbra.utils.render.shader.CircleShaderProgram;
import gg.umbra.utils.render.shader.CompositeRoundedRectShaderProgram;
import gg.umbra.utils.render.shader.LegacyDualRadiusRoundedRectShaderProgram;
import gg.umbra.utils.render.shader.LegacyGradientRoundedRectShaderProgram;
import gg.umbra.utils.render.shader.LegacyRoundedRectShaderProgram;
import gg.umbra.utils.render.shader.RingShaderProgram;
import gg.umbra.utils.render.shader.RoundedCornerMaskShaderProgram;
import gg.umbra.utils.render.shader.RoundedRectBorderShaderProgram;
import gg.umbra.utils.render.shader.RoundedRectShaderProgram;
import gg.umbra.utils.render.shader.RoundedRectShadowShaderProgram;
import gg.umbra.utils.render.shader.TexturedCircleShaderProgram;
import gg.umbra.utils.render.shader.TexturedQuadShaderProgram;
import gg.umbra.utils.render.shader.TexturedRoundedRectShaderProgram;
import gg.umbra.utils.render.shader.VignetteShaderProgram;
...
import gg.umbra.wrapper.impl.Matrix4fHandle;
...
public class GuiRenderPrimitives {
    ...
    private static Void lambda$drawItemSprite$0(double d, ItemStack itemStack, double d2, double d3) {
        ...
        Wrapper wrapper;
        double d4 = Umbra.INSTANCE.getClientSettings().getGuiScaleFactor();
        double d5 = d * d4;
