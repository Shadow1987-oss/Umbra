...
import gg.umbra.utils.render.RenderBatchBuffer;
...
import gg.umbra.utils.render.RenderBatchStateFlags;
import gg.umbra.utils.render.RenderMatrixStack;
import gg.umbra.utils.render.TextureAtlasRegistry;
import gg.umbra.utils.render.VertexAttributeType;
import gg.umbra.wrapper.impl.ForgeVersion;
import gg.umbra.wrapper.impl.GlStateManager;
import gg.umbra.wrapper.impl.Minecraft;
import gg.umbra.wrapper.impl.TextureManagerHandle;
import gg.umbra.wrapper.impl.TextureObjectHandle;
...
public class RenderBatchManager {
    ...
    public void queueGuiBatch(RenderBatchBuilder builder) {
        if (builder.getTexture() == null) {
            builder.setTexture(TextureAtlasRegistry.getInstance().get("umbra_texture").getTexture());
        }
    ...
    private void logFramebufferFailure(String reason, Throwable error) {
        ...
        Umbra.debugLog("RenderBatchManager 26.2: " + reason);
        if (error != null) {
    ...
    public RenderBatchManager() {
        ...
        try {
            ...
            textureAtlasRegistry.setActiveAtlas(textureAtlasRegistry.getOrCreate("umbra_texture"));
        }
        catch (Throwable throwable) {
