...
import gg.umbra.utils.render.EntityModelRenderBackend;
...
import gg.umbra.wrapper.impl.AbstractClientPlayer;
...
implements EntityModelRenderBackend {
    ...
    private void captureTextureInternal(ResourceLocation texture) {
        ...
        try {
            ...
            Umbra.debugLog(CAPTURE_ERROR_PREFIX + exception.getMessage());
