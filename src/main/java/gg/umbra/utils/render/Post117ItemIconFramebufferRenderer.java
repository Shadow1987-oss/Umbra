...
import gg.umbra.utils.render.ItemIconRenderBackend;
import gg.umbra.utils.render.ItemStackRenderUtils;
import gg.umbra.utils.render.OpenGlBackendHolder;
import gg.umbra.utils.render.Post117RenderPhaseCompat;
        ...
        if (scissorEnabled) {
            ...
            if (ForgeVersion.MC_1_20_6.d()) {
                ...
                if (ForgeVersion.MC_1_21_10.d()) {
                    ...
                    RenderBufferBridge renderBuffer = Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().V();
                    renderBuffer.j();
