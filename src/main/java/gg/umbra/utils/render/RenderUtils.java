...
public final class RenderUtils {
    ...
    public static void C(int mouseX, int mouseY) {
        double d = 2.0 * Umbra.INSTANCE.getClientSettings().getGuiScaleFactor();
    ...
    public static void X(double d, double d2, double d3, double d4) {
        ...
        gg.umbra.wrapper.impl.GL11.X(2978, intBuffer);
        k.push(new GlScissorRect(intBuffer.get(0), intBuffer.get(1), intBuffer.get(2), intBuffer.get(3)));
        int n = Minecraft.h();
        double d5 = 2.0 * Umbra.INSTANCE.getClientSettings().getGuiScaleFactor();
        int n2 = (int)(d3 * d5);
        int n3 = (int)(d4 * d5);
        double d6 = d * d5;
        int n4 = (int)d6;
    ...
    public static void m(double d, double d2, double d3, double d4) {
        ...
        if (GL11.glIsEnabled((int)3089)) {
            bl = true;
            g.clear();
            gg.umbra.wrapper.impl.GL11.X(3088, g);
            n = g.get(0);
            n2 = g.get(1);
            n3 = g.get(2);
            n4 = g.get(3);
            ...
            IntBuffer intBuffer = BufferUtils.createIntBuffer((int)16);
            gg.umbra.wrapper.impl.GL11.X(3088, intBuffer);
            A = intBuffer.get(0);
            r = intBuffer.get(1);
            z = intBuffer.get(2);
            y = intBuffer.get(3);
