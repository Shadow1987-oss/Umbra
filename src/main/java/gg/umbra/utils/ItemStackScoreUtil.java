...
import gg.umbra.wrapper.impl.ArmorMaterial;
import gg.umbra.wrapper.impl.AttributeModifier;
import gg.umbra.wrapper.impl.ChestTypeHolder;
...
import gg.umbra.wrapper.impl.EntityEquipmentSlot;
import gg.umbra.wrapper.impl.EntityPlayerSP;
import gg.umbra.wrapper.impl.EnumCreatureAttribute;
import gg.umbra.wrapper.impl.EquipmentSlotGroup;
import gg.umbra.wrapper.impl.Equippable;
import gg.umbra.wrapper.impl.FoodProperties;
import gg.umbra.wrapper.impl.Foods;
import gg.umbra.wrapper.impl.ForgeVersion;
import gg.umbra.wrapper.impl.Item;
import gg.umbra.wrapper.impl.ItemArmor;
import gg.umbra.wrapper.impl.ItemAttributeModifiers;
import gg.umbra.wrapper.impl.ItemAttributeModifiersComponent;
import gg.umbra.wrapper.impl.ItemAttributeModifiersComponent$Entry;
import gg.umbra.wrapper.impl.ItemCameraTransformBase;
import gg.umbra.wrapper.impl.ItemCameraTransformLeaf;
import gg.umbra.wrapper.impl.ItemCameraTransformSubtypeValue;
import gg.umbra.wrapper.impl.ItemCameraTransformType;
import gg.umbra.wrapper.impl.ItemSplashPotion;
import gg.umbra.wrapper.impl.ItemStack;
import gg.umbra.wrapper.impl.ItemSword;
import gg.umbra.wrapper.impl.ItemTool;
import gg.umbra.wrapper.impl.MonsterAttributesBridge;
import gg.umbra.wrapper.impl.NonNullList;
import gg.umbra.wrapper.impl.PotionEffect;
import gg.umbra.wrapper.impl.PotionRegistry;
import gg.umbra.wrapper.impl.ResourceKey;
import gg.umbra.wrapper.impl.ResourceKeyHolder;
import gg.umbra.wrapper.impl.ResourceLocation;
import gg.umbra.wrapper.impl.Slot;
import gg.umbra.wrapper.impl.StatusEffect;
import gg.umbra.wrapper.impl.ToolMaterial;
...
public class ItemStackScoreUtil {
    ...
    public static float O(EntityPlayerSP entityPlayerSP) {
        float f = 0.0f;
        Container container = entityPlayerSP.F$src$Lgg_umbra_wrapper_impl_Container_$152y6lm();
        for (int i = 0; i < 45; ++i) {
            ItemStack itemStack;
            float f2;
    ...
    public static int H(Item item) {
        ...
        if (ForgeVersion.MC_1_21_4.d()) {
            ...
            if (object != null) {
                ...
                EntityEquipmentSlot entityEquipmentSlot = equippable.m$src$Lgg_umbra_wrapper_impl_EntityEquipmentSlot_$bzr9md();
    ...
    private static int lambda$populateItems$0(ItemStack itemStack, ItemStack itemStack2) {
        ...
        ItemMappingEntry itemMappingEntry2 = Umbra.INSTANCE.getItemStackResolver().resolve(itemStack2);
    ...
    public static boolean R(Item item) {
        if (ForgeVersion.MC_1_21_6.d()) {
            ...
            return equippable.m$src$Lgg_umbra_wrapper_impl_EntityEquipmentSlot_$bzr9md().v();
        }
        if (ForgeVersion.MC_1_21_4.d()) {
    ...
    public static boolean T$src$Z$2fnsig(ItemStack itemStack) {
        ...
        if (ForgeVersion.MC_1_21_4.d()) {
            ...
            if (ArmorMaterial.gold().equals(itemArmor.Y$src$Lgg_umbra_wrapper_impl_ArmorMaterial_$11f9rp6())) {
                return true;
            }
        }
        return false;
