...
public class EventBuilder {
    ...
    public void buildEventDispatchInstructions() {
        ...
        instructions.add(new MethodInsnNode(182, eventInternalName, EventDispatcher.getFireMethod(this.eventClass).getName(), "()Z", false));
    ...
    public EventBuilder(int injectionPoint, Class eventClass, ClassNode classNode, MethodInfo methodInfo,
        ...
        if (this.targetMethod == null) {
            Umbra.debugLog("Couldnt find method node");
        }
