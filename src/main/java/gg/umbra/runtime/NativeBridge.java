...
import gg.umbra.reflect.Badlion189Mappings;
import gg.umbra.reflect.Fabric12111Mappings;
import gg.umbra.reflect.Fabric262Mappings;
import gg.umbra.reflect.Type;
import gg.umbra.reflect.Vanilla1122Mappings;
import gg.umbra.reflect.Vanilla1206Mappings;
import gg.umbra.reflect.Vanilla12111Mappings;
import gg.umbra.reflect.Vanilla1710Mappings;
import gg.umbra.reflect.Vanilla189Mappings;
import gg.umbra.reflect.Vanilla262Mappings;
...
public class NativeBridge {
    ...
    public static void start() throws Throwable {
        ...
        NativeBridge.invokeVoidInit(umbra, "loadMappings");
    ...
    private static int detectVanillaMappingVersion(
        ...
        if (matchingVersions == 1) {
            ...
            if (vanilla1710) {
                ...
                detectedVersion = 61;
            } else if (vanilla262 || fabric262) {
                // Umbra: both 26.1.x and 26.2 match the 26.2 structure; use the
                // real version string to pick the correct effective version.
                detectedVersion = Vanilla262Mappings.detectGameVersion(preferredLoaders);
            }
        }
        if (detectedVersion != 0) {
