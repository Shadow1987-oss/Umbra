...
extends ExprEditor {
    ...
    public void edit(MethodCall methodCall) throws CannotCompileException {
        ...
        if (ForgeVersion.MC_1_7_10.Y() && ForgeVersion.MC_1_16_5.v() && !methodCall.getMethodName().equals(Umbra.INSTANCE.getMappings().Dt.q.getResolvedName())) {
            return;
        }
        if (ForgeVersion.MC_1_16_5.d() && ForgeVersion.MC_1_17.v() && !methodCall.getMethodName().equals(Umbra.INSTANCE.getMappings().f.v.getResolvedName())) {
            return;
        }
