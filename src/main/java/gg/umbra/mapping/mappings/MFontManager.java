...
extends Mapping {
    ...
    public Object x(Object object, String string) {
        ...
        try {
            ...
            Umbra.debugLog("[FontManagerHook] Error getting FontSet for " + string + ": " + exception.getMessage());
        }
    ...
    private MFontManager(String string) {
        ...
        if (string != null) {
            if (MappedClasses.lr == null) {
                Umbra.debugLog("[FontManagerHook] FontManagerClass is null - not available on this version");
                return;
            }
    ...
    public Object u(Object object) {
        ...
        try {
            ...
            Umbra.debugLog("[FontManagerHook] Error getting default FontSet: " + exception.getMessage());
        }
        return this.x(object);
    }
