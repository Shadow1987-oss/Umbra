...
extends Mapping {
    ...
    private MTitledScreen(int initializationState) {
        ...
        if (ForgeVersion.MC_1_8_9.d()) {
            ...
            if (this.renderHudMethod != null && !Wrapper.isNativeAvailable && !this.renderHudMethod.hasResolutionFailed() && Umbra.INSTANCE.isMappingsRemapped()) {
                if (ForgeVersion.MC_1_16_5.d()) {
            ...
            if (!Wrapper.isNativeAvailable && !this.renderHudMethod.hasResolutionFailed() && Umbra.INSTANCE.isMappingsRemapped()) {
