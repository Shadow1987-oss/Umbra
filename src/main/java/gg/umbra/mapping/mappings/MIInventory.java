...
extends Mapping {
    ...
    private MIInventory(int[] nArray) {
        ...
        if (nArray != null) {
            ...
            boolean bl3 = true;
            String string3 = Wrapper.umbraInstance.isVanillaMinecraftPresent() ? "isCustomInventoryName" : "hasCustomInventoryName";
        ...
        if (ForgeVersion.MC_1_7_10.L()) {
            ...
            boolean bl6 = true;
            String string6 = Wrapper.umbraInstance.isVanillaMinecraftPresent() ? "isCustomInventoryName" : "hasCustomInventoryName";
