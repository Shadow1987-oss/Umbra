...
import gg.umbra.mapping.NativeMappedMemberInvoker;
import gg.umbra.mapping.access.GeneratedAccessorFactory;
import gg.umbra.mapping.access.MethodInvoker;
import gg.umbra.mapping.runtime.MemberLookupSignature;
...
public class MappingMethod {
    ...
    public void initializeAccessor(Class<?> owner) {
        if ((Umbra.INSTANCE.isMappingsRemapped() || Umbra.INSTANCE.isForgeRemapInactive()) && !this.resolutionFailed) {
    ...
    public String getResolvedName() {
        if (Umbra.INSTANCE.isForgeRemapInactive()) {
    ...
    public MappingMethod register() {
        ...
        try {
            ...
            if (!this.skipAccessorGeneration && !Umbra.INSTANCE.isForgeRemapInactive()) {
