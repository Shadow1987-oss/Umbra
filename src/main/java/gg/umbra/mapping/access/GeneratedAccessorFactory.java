...
import gg.umbra.mapping.access.FieldAccessor;
import gg.umbra.mapping.access.GeneratedAccessorClassDefiner;
import gg.umbra.mapping.access.MethodInvoker;
...
public class GeneratedAccessorFactory {
    ...
    public static Class<? extends GeneratedEventListenerInvokerMarker> N(Class<?> clazz, Method method) {
        Class<?> parameterType;
        GeneratedAccessorFactory.s();
        String string = GeneratedAccessorFactory.x(clazz, method);
        ClassWriter classWriter = new ClassWriter(3);
        classWriter.visit(52, 1, string.replace('.', '/'), null, Type.getInternalName(Object.class), new String[]{Type.getInternalName(GeneratedEventListenerInvokerMarker.class)});
        GeneratorAdapter generatorAdapter = new GeneratorAdapter(classWriter.visitMethod(1, "<init>", "()V", null, null), 1, "<init>", "()V");
        generatorAdapter.loadThis();
        generatorAdapter.visitMethodInsn(183, Type.getInternalName(Object.class), "<init>", "()V", false);
        generatorAdapter.returnValue();
        ...
        byte[] byArray = classWriter.toByteArray();
        try {
            return GeneratedAccessorClassDefiner.o.defineGeneratedAccessorClass(GeneratedAccessorFactory.class.getClassLoader(), string, byArray).asSubclass(GeneratedEventListenerInvokerMarker.class);
        }
        catch (Exception exception) {
            return null;
        }
    ...
    private static Method s() {
        if (c == null) {
            ...
            for (Method method : GeneratedEventListenerInvokerMarker.class.getDeclaredMethods()) {
