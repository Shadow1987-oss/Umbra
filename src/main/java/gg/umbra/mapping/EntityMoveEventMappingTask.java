...
import gg.umbra.event.impl.EventPostMove;
import gg.umbra.event.impl.EventPreMove;
...
extends JavassistMappingTask {
    private void k() {
        if (ForgeVersion.MC_1_16_5.d()) {
            MappingMethod mappingMethod = Umbra.INSTANCE.getMappings().Rr.jG;
            String string = "$2";
        ...
        MappingMethod mappingMethod = Umbra.INSTANCE.getMappings().Rr.j0;
