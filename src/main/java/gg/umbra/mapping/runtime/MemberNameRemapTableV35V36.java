...
extends MemberNameRemapTable {
    ...
    protected void e() {
        this.t(MappedClasses.VJ, "getEntitiesWithinAABBForEntity", Umbra.INSTANCE.isVanillaMinecraftPresent() ? "getEntities" : "func_177414_a");
    }
    ...
    protected void Qr() {
        ...
        this.t(MappedClasses.Z, "removeEntity", Umbra.INSTANCE.isVanillaMinecraftPresent() ? "onEntityRemovedVanilla" : "onEntityRemoved");
    ...
    protected void u6() {
        ...
        this.t(MappedClasses.zc, "isOffsetPositionInLiquid", Umbra.INSTANCE.isVanillaMinecraftPresent() ? "isFree" : "func_70038_c");
        ...
        this.t(MappedClasses.zc, "setPositionAndRotation", Umbra.INSTANCE.isVanillaMinecraftPresent() ? "absMoveTo" : "func_70080_a");
    ...
    protected void ue() {
        ...
        if (Umbra.INSTANCE.isVanillaMinecraftPresent() || !Umbra.INSTANCE.isForgeAbsent()) {
    ...
    protected void QS() {
        this.b(MappedClasses.u4, "getSprite", "func_215288_a", Umbra.INSTANCE.isForgeAbsent());
    }
