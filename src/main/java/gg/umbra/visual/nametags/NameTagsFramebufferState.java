...
public class NameTagsFramebufferState {
    ...
    public void beginRendering() {
        ...
        gg.umbra.wrapper.impl.GL11.X(2978, this.previousViewport);
        IntBuffer framebufferBinding = BufferUtils.createIntBuffer((int)16);
        gg.umbra.wrapper.impl.GL11.X(36006, framebufferBinding);
