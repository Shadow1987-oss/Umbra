...
import gg.umbra.visual.search.SearchBlockChunkScanner;
import gg.umbra.visual.search.SearchBlockRenderEntry;
import gg.umbra.rotation.LocalPlayerRotationUtil;
...
import gg.umbra.utils.datas.SearchResultDataPool;
import gg.umbra.utils.processors.SearchProcessor;
...
import gg.umbra.utils.render.RenderBatchState;
...
extends HackModule {
    ...
    private final SliderSetting dummyRange;
    ...
    private final ToggleSetting onlyCaves;
    private final List<SearchResultData> searchResults;
    private final ToggleSetting useTracers;
    ...
    public BlockFinder() {
        ...
        this.dummyRange = SliderSetting.create((Object)this, "-", "-", "-", 5.0, 5.0, 5.0, 1.0);
        this.onlyCaves = ToggleSetting.create(this, "Only caves", false, "Only looks for ores exposed to air");
        this.useTracers = ToggleSetting.create(this, "Use tracers", false, "Add tracers to search blocks");
    ...
    private void onOnlyCavesChanged(ToggleSetting booleanValue) {
    ...
    public void onRender3D(EventRender3D eventRender3D) {
        ...
        if (ForgeVersion.MC_1_16_5.d()) {
            cameraYOffset = Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().l().o().getY() - renderY;
        }
