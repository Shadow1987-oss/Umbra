...
import gg.umbra.wrapper.impl.TileEntityMobSpawner;
import java.awt.Color;
import org.lwjgl.opengl.GL11;

public class SpawnerFinder
extends HackModule {
    private final OptionalItemFilter spawnerWhitelist;
    private final Color backgroundColor = new Color(20, 20, 20, 128);
    private final ToggleSetting showDistance;
    private final SliderSetting scale = SliderSetting.create((Object)this, "Scale", "#.#", "", 0.1, 1.0, 1.5, 0.1);
    ...
    public SpawnerFinder() {
        ...
        this.spawnerWhitelist = OptionalItemFilter.create(this, "Spawner names-whitelist", "Spawners", OptionalItemFilter.ALLOW_LIST_COLOR, "Zombie", "Skeleton", "Creeper", "Spider");
