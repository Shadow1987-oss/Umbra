...
extends HackModule {
    ...
    public Projectiles() {
        ...
        this.showPearls = ToggleSetting.create(this, "Show Pearls", true);
        this.showPotions = ToggleSetting.create(this, "Show Potions", false);
        this.showEggs = ToggleSetting.create(this, "Show Eggs", false);
        this.showSnowballs = ToggleSetting.create(this, "Show Snowballs", false);
    ...
    private void simulateTrajectory(EntityEnderPearl entity, IProjectile projectile) {
        ...
        while (true) {
            ...
            for (Object entityHandle : candidates) {
                ...
                AxisAlignedBB candidateBounds = candidate.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().expand(0.3, 0.3, 0.3);
