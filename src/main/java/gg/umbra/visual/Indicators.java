...
import gg.umbra.visual.proj.IProjectile;
import gg.umbra.visual.proj.PotionProjectile;
...
import gg.umbra.utils.render.ItemStackRenderUtils;
...
extends HackModule {
    private final ToggleSetting showEggs;
    private final ToggleSetting showArrows;
    ...
    private final ToggleSetting showDistance;
    private final Map<Entity, double[]> projectedPositions;
    private final ToggleSetting showFireballs;
    private EntityOtherPlayerMP collisionProbe;
    private final ToggleSetting showPearls;
    ...
    private final ColorPicker uncommonProjectileColor;
    private ItemStack pearlItem;
    private final ToggleSetting showSnowballs;
    private final OptionSetting alertType;
    private final SliderSetting radiusScale;
    ...
    private final ToggleSetting showPotions;
    ...
    private double simulateThrownProjectile(EntityPlayerSP player, WorldClient world,
        ...
        while (true) {
            ...
            for (Object candidate : candidates) {
                ...
                AxisAlignedBB entityBounds = entity.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl()
                        .expand(0.3, 0.3, 0.3);
    ...
    public Indicators() {
        ...
        this.alertType = OptionSetting.create((Object)this, "Alert Type", this.threatMode, this.alwaysMode, this.threatMode, this.hitOnlyMode);
        this.uncommonProjectileColor = ColorPicker.create(this, "Uncommon Projectile Color", new Color(255, 0, 0));
        this.showDistance = ToggleSetting.create(this, "Show Distance", false, "Renders the distance next to the arrow.");
        this.radiusScale = SliderSetting.create((Object)this, "Radius Scale", "#.##", "x", 0.0, 0.15, 1.0, 0.05);
        this.showArrows = ToggleSetting.create(this, "Show Arrows", true);
        this.showPearls = ToggleSetting.create(this, "Show Pearls", false);
        this.showPotions = ToggleSetting.create(this, "Show Potions", false);
        this.showEggs = ToggleSetting.create(this, "Show Eggs", true);
        this.showSnowballs = ToggleSetting.create(this, "Show Snowballs", true);
        this.showFireballs = ToggleSetting.create(this, "Show Fireballs", true);
