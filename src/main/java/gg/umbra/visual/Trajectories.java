...
import gg.umbra.visual.trajectories.TrajectoriesProjectileRenderState;
...
import gg.umbra.visual.trajectories.WideArrowProjectile;
...
import gg.umbra.wrapper.impl.TrajectoriesItemBridge;
...
extends HackModule {
    ...
    private final ColorPicker trajectoryColor;
    private boolean entityHitLastFrame;
    private final PotionProjectile potionProjectile;
    private final ColorPicker aimingColor = ColorPicker.create(this, "Aiming Color", new Color(255, 255, 255));
    private Color currentColor;
    private final ToggleSetting ghostBowCharge;
    ...
    public Trajectories() {
        ...
        this.ghostBowCharge = ToggleSetting.create(this, "Ghost Bow Charge", false, "Draws a ghost trajectory of a fully charged\nshot when not pulling back bow");
        ...
        this.targetColor = ColorPicker.create(this, "Target Color", new Color(0, 0, 255, 255));
        this.trajectoryColor = ColorPicker.create(this, "Trajectory Color", new Color(255, 0, 0, 255));
    ...
    public void onRender3D(EventRender3D event) {
        ...
        RenderUtils.g();
        RenderUtil.d();
        Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().B(0.0);
        ...
        while (!collided) {
            ...
            for (Object candidate : candidates) {
                ...
                AxisAlignedBB entityBounds = entity.u$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$kogbsu()
                        .expand(0.3, 0.3, 0.3);
        ...
        if (isCollision.test(hit)) {
            ...
            if (ForgeVersion.MC_1_16_5.v() || RayTraceResult_type.block().equals(hitType)) {
                ...
                AxisAlignedBB entityBounds = hitEntity.u$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$kogbsu()
                        .expand(0.3, 0.3, 0.3);
        ...
        Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf().O(0.0);
        RenderUtils.f();
