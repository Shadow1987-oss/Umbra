...
import gg.umbra.wrapper.impl.C06PacketPlayerPositionLook;
import gg.umbra.wrapper.impl.CPacketPlayerPosition;
import gg.umbra.wrapper.impl.CPacketPlayer_Rotation;
...
extends FreecamController<GhostCamera> {
    @Listen
    ...
    private CPacketPlayerPosition buildPositionPacket() {
        if (ForgeVersion.MC_1_7_10.L()) {
            return CPacketPlayerPosition.newInstance(this.module.fakePlayer.z(), this.module.fakePlayer.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().getMinY(), this.module.fakePlayer.N(), this.module.fakePlayer.h(), this.module.fakePlayer.b$src$Z$fqlxe4());
        }
    ...
    private C06PacketPlayerPositionLook buildPositionLookPacket() {
        if (ForgeVersion.MC_1_7_10.L()) {
            return C06PacketPlayerPositionLook.create(this.module.fakePlayer.z(), this.module.fakePlayer.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().getMinY(), this.module.fakePlayer.N(), this.module.fakePlayer.h(), this.module.fakePlayer.J(), this.module.fakePlayer.V(), this.module.fakePlayer.b$src$Z$fqlxe4());
        }
    ...
    private void applyGhostPositionLook(PlayerPositionLookPacketModern packet) {
        ...
        if (ForgeVersion.MC_1_7_10.Y()) {
            ...
            if (packet.getRelativeFlags().contains(PlayerInteractEventAction.t$src$Lgg_umbra_wrapper_impl_PlayerInteractEventAction_$1n8jtc5().getObject())) {
                y += fakePlayer.N();
            } else {
                fakePlayer.k(0.0);
            }
            ...
            if (packet.getRelativeFlags().contains(PlayerInteractEventAction.m$src$Lgg_umbra_wrapper_impl_PlayerInteractEventAction_$1581zn0().getObject())) {
                yaw += fakePlayer.J();
            }
    ...
    public FreecamLegacyController(GhostCamera freecam) {
        super(freecam);
    }
    ...
    private C03PacketPlayer buildMovementPacket() {
        ...
        double reportedY = ClientSettings.IS_LEGACY_1_7 ? fakePlayer.u$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$kogbsu().getMinY() : fakePlayer.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().getMinY();
        ...
        if (fakePlayer.S$src$Lgg_umbra_wrapper_impl_Entity_$dgzs12().isNotNull()) {
        ...
        if (positionChanged) {
            ...
            this.module.lastReportedY = ClientSettings.IS_LEGACY_1_7 ? fakePlayer.N() : fakePlayer.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().getMinY();
