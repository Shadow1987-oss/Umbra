...
extends FreecamController<GhostCamera> {
    ...
    private void handleMovement() {
        ...
        strafe = ClientSettings.isPhysicalKeyDown(Minecraft.gameSettings().x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg()) ? 1.0 : 0.0;
        if (ClientSettings.isPhysicalKeyDown(Minecraft.gameSettings().g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3())) {
            strafe -= 1.0;
        }
        vertical = ClientSettings.isPhysicalKeyDown(Minecraft.gameSettings().O()) ? 1.0 : 0.0;
        if (ClientSettings.isPhysicalKeyDown(Minecraft.gameSettings().d$src$Lgg_umbra_wrapper_impl_KeyBinding_$adn2z0())) {
            vertical -= 1.0;
        }
    ...
    public FreecamModernController(GhostCamera freecam) {
        super(freecam);
    }
    ...
    private boolean isMovementKey(Object keyBindingHandle) {
        ...
        return keyBinding.equals(Minecraft.gameSettings().Y()) || keyBinding.equals(Minecraft.gameSettings().s()) || keyBinding.equals(Minecraft.gameSettings().x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg()) || keyBinding.equals(Minecraft.gameSettings().g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3()) || keyBinding.equals(Minecraft.gameSettings().O()) || keyBinding.equals(Minecraft.gameSettings().d$src$Lgg_umbra_wrapper_impl_KeyBinding_$adn2z0()) || keyBinding.equals(Minecraft.gameSettings().r());
    }
