...
import gg.umbra.visual.pearl.PearlEspEnderPearlEntityWrapper;
import gg.umbra.utils.render.OpenGlBackendHolder;
import gg.umbra.utils.render.RenderUtil;
import gg.umbra.utils.render.glu.GluSphere;
...
extends HackModule {
    public final ToggleSetting showBlastRing = ToggleSetting.create(this, "Blast ring", true, "Shows the blast radius where blocks will be broken");
