...
extends HackModule {
    ...
    private final ColorPicker color = ColorPicker.create(this, "Color", new Color(255, 0, 0));
    private static final long MODULE_COLOR = 6320396365828000318L;
    private final ToggleSetting scaleOpacity;
    ...
    public boolean shouldTrack(Entity entity) {
        ...
        if (Umbra.INSTANCE.getClientSettings().isBot(player)) {
            return false;
        }
        if (Umbra.INSTANCE.getClientSettings().isTeammate(player)) {
            return false;
        }
    ...
    public Arrows() {
        ...
        this.scaleOpacity = ToggleSetting.create(this, "Scale Opacity", false, "Lowers the opacity the farther they are.");
        this.radiusScale = SliderSetting.create((Object)this, "Radius Scale", "#.##", "x", 0.0, 0.5, 1.0, 0.05);
