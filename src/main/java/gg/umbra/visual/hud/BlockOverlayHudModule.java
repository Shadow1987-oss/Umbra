...
extends HudModule {
    private final ColorPicker overlayColor = ColorPicker.create(this, "Overlay Color", new Color(255, 0, 0, 95));
    private final ColorPicker outlineColor = ColorPicker.create(this, "Outline Color", new Color(255, 0, 0, 200));
    ...
    private AxisAlignedBB resolveTargetBounds(RayTraceResult target, WorldClient world) {
        Block block = target.Z$src$Lgg_umbra_wrapper_impl_Block_$6x2c9a();
        ...
        EntityFishHook shape = blockReader.getShape(
                Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf()
                        .l().x$src$Lgg_umbra_wrapper_impl_BlockReader_$120g8sh(),
                position);
