...
import gg.umbra.tools.inventory.cleaner.AbstractInventoryFilterRule;
...
extends AbstractInventoryFilterRule {
    ...
    public InventoryFilterPreset resolvePreset() {
        ...
        if (sharedPresetId != null) {
            return Umbra.INSTANCE.getInventoryFilterPresetRegistry().getItemRulePresets().getById(sharedPresetId);
        }
