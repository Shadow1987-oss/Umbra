...
import gg.umbra.tools.inventory.cleaner.ui.InventoryCleanerPopupOutsideClickFilter;
import gg.umbra.tools.inventory.cleaner.ui.InventoryCleanerProfileEditContext;
...
import gg.umbra.tools.inventory.cleaner.ui.InventoryFilterRuleListPanel;
import gg.umbra.tools.inventory.cleaner.ui.InventoryFilterRuleRowBase;
...
import gg.umbra.tools.inventory.cleaner.ui.SlotInventoryFilterRuleRow;
...
import gg.umbra.ui.click.frame.DimmedCenteredPopupFrame;
...
extends Frame {
    ...
    public void editProfile(InventoryCleanerProfileValue inventoryCleanerProfileValue, InventoryCleanerProfile inventoryCleanerProfile, Runnable runnable) {
        ...
        panelComponent.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
    ...
    public static void openRuleEditor(InventoryFilterRule rule, InventoryFilterPreset currentPreset, InventoryFilterPreset editedPreset, boolean newlyAddedRule) {
        ...
        if (profileEditor.u$src$Lgg_umbra_ui_click_frame_FrameStackManager_$12v9ioe() instanceof ClickGuiFrameManager) {
            ClickGuiFrameManager clickGuiFrameManager = (ClickGuiFrameManager)profileEditor.u$src$Lgg_umbra_ui_click_frame_FrameStackManager_$12v9ioe();
    ...
    @Nullable
    public FrameStackManager u$src$Lgg_umbra_ui_click_frame_FrameStackManager_$12v9ioe() {
    ...
    private void promptDeleteProfile(InventoryCleanerProfileValue inventoryCleanerProfileValue, InventoryCleanerProfile inventoryCleanerProfile, Runnable runnable) {
        ...
        DimmedCenteredPopupFrame dimmedCenteredPopupFrame = ClientSettings.createPopup(this.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa(), confirmationDialogComponent, DimmedCenteredPopupFrame.class);
    ...
    public static void returnToProfileEditor() {
        ...
        if (inventoryCleanerPopupFrame.u$src$Lgg_umbra_ui_click_frame_FrameStackManager_$12v9ioe() instanceof ClickGuiFrameManager) {
            ClickGuiFrameManager clickGuiFrameManager = (ClickGuiFrameManager)inventoryCleanerPopupFrame.u$src$Lgg_umbra_ui_click_frame_FrameStackManager_$12v9ioe();
