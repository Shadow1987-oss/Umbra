...
import gg.umbra.tools.inventory.cleaner.EmptyInventoryFilterCondition;
import gg.umbra.tools.inventory.cleaner.InventoryFilterConditionGroup;
import gg.umbra.tools.inventory.cleaner.InventoryFilterLogicalOperator;
import gg.umbra.tools.inventory.cleaner.InventoryFilterPreset;
import gg.umbra.tools.inventory.cleaner.InventoryFilterRule;
import gg.umbra.tools.inventory.cleaner.InventoryFilterRulePresetChange;
import gg.umbra.tools.inventory.cleaner.ItemInventoryFilterRule;
...
import gg.umbra.tools.inventory.cleaner.ui.InventoryFilterConditionGroupPanel;
import gg.umbra.tools.inventory.cleaner.ui.InventoryFilterRuleEditorPanel;
import gg.umbra.ui.click.component.ConfirmationDialogComponent;
import gg.umbra.ui.click.component.FilledSpacerComponent;
...
import gg.umbra.ui.click.component.gui.TextLabel;
...
import gg.umbra.ui.click.frame.ScrollableFrameComponent;
...
extends Frame {
    ...
    private void closePopup() {
        ...
        if (inventoryFilterRuleEditorPanel != null) {
            ...
            inventoryCleanerPopupFrame.openRuleSettings(popupFrame.V$src$Lgg_umbra_ui_click_component_GuiComponent_$jpbobc(), inventoryFilterRuleEditorPanel.getProfile(), inventoryFilterRule, false);
        }
    }
    ...
    public void showRuleEditor(InventoryFilterRule rule, InventoryFilterPreset currentPreset, InventoryFilterPreset editedPreset, boolean newlyAddedRule, boolean preserveScroll) {
        ...
        this.contentScroll.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M(null);
        ...
        frameComponent.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        frameComponent.setShowDisabledOverlay(false);
        ...
        panelComponent2.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        ...
        ((FrameComponent)guiComponent2).l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        ...
        panelComponent3.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        ...
        this.conditionsScroll.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        ...
        panelComponent4.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("widthwrap");
        ...
        panelComponent3.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("widthwrap");
        panelComponent3.setShowDisabledOverlay(false);
    ...
    private void deletePresetConfirmed(InventoryFilterPreset inventoryFilterPreset, InventoryFilterRule inventoryFilterRule) {
        Umbra.INSTANCE.getInventoryFilterPresetRegistry().clearReferencesTo((SharedInventoryFilterPreset)inventoryFilterPreset);
        if (inventoryFilterRule instanceof SlotInventoryFilterRule) {
            Umbra.INSTANCE.getInventoryFilterPresetRegistry().getSlotRulePresets().remove((SharedInventoryFilterPreset)inventoryFilterPreset);
        } else {
            Umbra.INSTANCE.getInventoryFilterPresetRegistry().getItemRulePresets().remove((SharedInventoryFilterPreset)inventoryFilterPreset);
        }
        this.closePopup();
    }
    ...
    private void applySharedPreset(boolean createSharedPreset, InventoryFilterPreset editedPreset, InventoryFilterRule rule, InventoryFilterPreset currentPreset) {
        ...
        if (slotRule) {
            Umbra.INSTANCE.getInventoryFilterPresetRegistry().getSlotRulePresets().replace(previousSharedPreset, newSharedPreset);
        } else {
            Umbra.INSTANCE.getInventoryFilterPresetRegistry().getItemRulePresets().replace(previousSharedPreset, newSharedPreset);
        }
        this.closePopup();
    }
