...
public class InventoryCleanerProfile {
    ...
    public OptionSetting armorMode;
    ...
    public void assignDefaultName() {
        int suffix = 1;
        for (InventoryCleanerProfile profile : Umbra.INSTANCE.getHackManager().getMod(InventoryManager.class).getProfileValue().getProfiles()) {
    ...
    public InventoryCleanerProfile(JsonObject jsonObject) {
        ...
        this.armorMode = OptionSetting.create((Object)this, "armor_mode", "", "Armor Mode", (ModeSelection)this.noArmorManagement, this.noArmorManagement, this.bestArmor);
