...
import gg.umbra.tools.inventory.cleaner.ui.ItemInventoryFilterRuleRow;
...
import gg.umbra.ui.click.component.TwoButtonConfirmationPopupComponent;
...
extends ScrollableFrameComponent {
    ...
    public InventoryFilterRuleListPanel(InventoryCleanerPopupFrame inventoryCleanerPopupFrame, FrameComponent frameComponent, InventoryCleanerProfile inventoryCleanerProfile) {
        ...
        this.clearAllPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("widthwrap");
    ...
    private void onClearAll(InventoryCleanerProfile inventoryCleanerProfile) {
        ...
        anchoredPopupFrame.q(this.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa(), anchoredPopupFrame);
