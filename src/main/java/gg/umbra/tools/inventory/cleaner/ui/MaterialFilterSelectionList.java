...
import gg.umbra.tools.inventory.cleaner.ui.MaterialFilterSelectionListClosePopupMouseListener;
import gg.umbra.tools.inventory.cleaner.ui.MaterialFilterSelectionRemoveClickHandler;
...
extends ScrollableFrameComponent {
    ...
    private void openItemPicker(GlyphIconComponent addButton) {
        ...
        popup.q(this.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa(), popup);
