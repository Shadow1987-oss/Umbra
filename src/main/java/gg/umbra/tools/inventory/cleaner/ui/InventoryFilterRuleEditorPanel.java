...
import gg.umbra.tools.inventory.cleaner.InventoryItemMatcherPresetRegistry;
...
import gg.umbra.tools.inventory.cleaner.ui.InventoryFilterPresetOptionComponent;
import gg.umbra.tools.inventory.cleaner.ui.ItemFilterSelectionComponent;
...
extends PanelComponent {
    ...
    private void renderContent() {
        ...
        if (inventoryFilterPreset != null) {
            ...
            ArrayList<InventoryFilterPreset> availablePresets = new ArrayList<InventoryFilterPreset>(this.rule instanceof SlotInventoryFilterRule ? Umbra.INSTANCE.getInventoryFilterPresetRegistry().getSlotRulePresets().getAll() : Umbra.INSTANCE.getInventoryFilterPresetRegistry().getItemRulePresets().getAll());
    ...
    public InventoryFilterRuleEditorPanel(InventoryCleanerProfile inventoryCleanerProfile, InventoryFilterRule inventoryFilterRule, boolean nestedEditor) {
        ...
        this.contentPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
