...
import gg.umbra.tools.inventory.cleaner.DurabilityValueMode;
...
import gg.umbra.tools.inventory.cleaner.EnchantmentFilterMode;
...
import gg.umbra.tools.inventory.cleaner.MembershipMode;
import gg.umbra.tools.inventory.cleaner.NumericFilterCondition;
import gg.umbra.tools.inventory.cleaner.PotionEffectFilterCondition;
import gg.umbra.tools.inventory.cleaner.PotionEffectFilterMode;
import gg.umbra.tools.inventory.cleaner.TextFilterCondition;
...
extends ScrollableFrameComponent {
    ...
    private void rebuild() {
        ...
        if (this.condition instanceof EmptyInventoryFilterCondition) {
            ...
            emptyInput.o(this.A() - this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C() - 17.5 - 20.0);
            emptyInput.Y(15.0);
            ...
            if (this.condition instanceof NumericFilterCondition && requiresComparisonValue) {
                ...
                numericInput.o(this.A() - this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C() - 17.5 - 20.0);
                numericInput.Y(15.0);
                ...
                TextSuggestionInputComponent suggestionInput = new TextSuggestionInputComponent("", row -> InventoryFilterConditionEditor.removeTextValue(textCondition, row), this.A() - this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C() - 17.5 - 20.0, 15.0, false, true);
                ...
                MaterialFilterSelectionList selectionList = new MaterialFilterSelectionList(this.filterRule, materialCondition, this.A() - this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C() - 36.0);
                ...
                this.h(new SpacerComponent(this.A() - this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C() - 17.5 - 20.0, 0.0), new Object[0]);
            } else {
                this.h(new SpacerComponent(this.A() - this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C() - 17.5 - 20.0, 0.0), new Object[0]);
            }
        }
    ...
    private static void parseNumericValue(NumericFilterCondition numericFilterCondition, LabeledTextInputComponent input, char character, int keyCode) {
        try {
            numericFilterCondition.parseValue(input.getText());
                ...
                Umbra.logThrowable(numberFormatException);
            }
    }
    ...
    public InventoryFilterConditionEditor(double width, InventoryFilterRule filterRule, InventoryFilterConditionGroup conditionGroup, InventoryFilterCondition<?> condition, Runnable onChanged) {
        ...
        this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("widthwrap");
