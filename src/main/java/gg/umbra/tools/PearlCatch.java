 ...
 */
public class PearlCatch extends UtilityHack {
    ...
    private final OptionSetting aimMode = OptionSetting.create(
            this,
            "Aim mode",
            ...
            this.upwardMode,
            this.currentAimMode);
    private final SliderSetting aimSpeed = SliderSetting.create(
            this, "Aim speed", "#.#", "", 1.0, 10.0, 10.0);
    private final ToggleSetting silentAim = ToggleSetting.create(this, "Silent aim", true, null);
    private final SliderSetting chargeDelay = SliderSetting.create(
            this,
            "Charge delay",
            "#",
            " ticks",
    ...
    private void throwFromSlot(int slot) {
        ...
        player.V$src$Lgg_umbra_wrapper_impl_InventoryPlayer_$erqak6().g(slot);
