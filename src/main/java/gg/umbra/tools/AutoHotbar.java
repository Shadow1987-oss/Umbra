...
import gg.umbra.inventory.InventoryClickAction;
import gg.umbra.inventory.InventoryClickQueue;
import gg.umbra.mapping.MappedClasses;
import gg.umbra.module.Category;
import gg.umbra.module.HackModule;
import gg.umbra.tools.inventory.ArmorSlotComparator;
import gg.umbra.tools.inventory.BowSlotComparator;
...
import gg.umbra.tools.inventory.InventoryManagerPrimaryItemScoreComparator;
import gg.umbra.tools.inventory.InventoryManagerSecondaryItemScoreComparator;
import gg.umbra.tools.inventory.FoodSlotComparator;
...
implements InventoryActionModule {
    private final SliderSetting delayMs = SliderSetting.create(this, "Delay", "#", "", 0.0, 110.0, 300.0);
    ...
    private final ToggleSetting openInventoryOption;
    ...
    public AutoHotbar() {
        ...
        this.openInventoryOption = ToggleSetting.create(this, "Open Inventory", true);
    ...
    public void onTick(EventPrePlayerTick event) {
        Container container;
        if (Umbra.INSTANCE.getHackManager().isOtherInventoryActionActive(AutoHotbar.class) || Umbra.INSTANCE.getClientSettings().isLobbyCheckActive()) {
            this.clickQueue.clear();
            this.clickTimer.reset();
            this.touchedSlots.clear();
            return;
