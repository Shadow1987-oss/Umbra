...
extends AbstractNotification {
    ...
    private double getRenderX() {
        return this.getCurrentX() + 3.0
                + (double)Minecraft.J() / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor() / 2.0;
    }
    ...
    private double getRenderY() {
        return this.getCurrentY()
                + (double)Minecraft.h() / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor() / 2.0;
    }
    ...
    public void render() {
        ...
        float inverseScale = (float)(1.0 / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor());
        ...
        Umbra.INSTANCE.getFontManager().W(0.9, true).d(this.getTitle(), renderX + 23.0,
