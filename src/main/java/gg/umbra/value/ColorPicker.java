...
extends Value<Object[], ColorPicker> {
    private final SliderSetting alphaValue;
    private final SliderSetting hueValue;
    private boolean colorTransformEnabled = false;
    private final SliderSetting brightnessValue;
    private final ToggleSetting rainbowValue;
    private final SliderSetting saturationValue;
    ...
    public SliderSetting getSaturationValue() {
    ...
    public ColorPicker copyDefinition() {
        ColorPicker colorValue = new ColorPicker(null, this.getName(), this.getHueRatio() * 255.0f, this.getBrightnessRatio() * 255.0f, this.getSaturationRatio() * 255.0f, this.getAlphaRatio() * 255.0f);
    ...
    @Override
    public ColorPicker copyValueDefinition() {
    ...
    public SliderSetting getAlphaValue() {
    ...
    ColorPicker(Object owner, String name, double hue, double brightness, double saturation, double alpha) {
        super(owner, name, new Object[0]);
        this.hueValue = SliderSetting.create(this, name + " hue", name + " hue", "", 0.0, hue, 255.0);
        this.brightnessValue = SliderSetting.create(this, name + " brightness", name + " brightness", "", 0.0, brightness, 255.0);
        this.saturationValue = SliderSetting.create(this, name + " saturation", name + " saturation", "", 0.0, saturation, 255.0);
        this.alphaValue = SliderSetting.create(this, name + " alpha", name + " alpha", "", 0.0, alpha, 255.0);
        this.rainbowValue = ToggleSetting.createWithDisplayName(this, name + " rainbow", name + " rainbow", false);
    ...
    public SliderSetting getHueValue() {
    ...
    public SliderSetting getBrightnessValue() {
        return this.brightnessValue;
    }

    public static ColorPicker createWithAlpha(Object owner, String name, Color color, int alpha) {
        float[] hsb = Color.RGBtoHSB(color.getRed(), color.getGreen(), color.getBlue(), null);
        float hue = hsb[0];
        float saturation = hsb[1];
        float brightness = hsb[2];
        return ColorPicker.createFromChannels(owner, name, hue * 255.0f, brightness * 255.0f, saturation * 255.0f, alpha);
    }
    ...
    public static ColorPicker createFromChannels(Object owner, String name, double hue, double brightness, double saturation, double alpha) {
        return new ColorPicker(owner, name, hue, brightness, saturation, alpha);
    }
    ...
    public static ColorPicker create(Object owner, String name, Color color) {
        float[] hsb = Color.RGBtoHSB(color.getRed(), color.getGreen(), color.getBlue(), null);
        float hue = hsb[0];
        float saturation = hsb[1];
        float brightness = hsb[2];
    ...
    private void clampChannelValue(SliderSetting numberValue) {
