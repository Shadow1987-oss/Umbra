...
public class OptionalItemFilter
extends ListValue<OptionalLimitEntry, OptionalItemFilter> {
    ...
    public OptionalItemFilter copyDefinition() {
        return new OptionalItemFilter(null, this.getId(), this.getName(), this.getAccentColor());
    }
    ...
    private OptionalItemFilter(Object owner, String id, String name, Color accentColor) {
        super(owner, id, name);
    ...
    @Override
    public OptionalItemFilter copyValueDefinition() {
    ...
    public static OptionalItemFilter createWithDescription(Object owner, String id, String name, String description, Color accentColor, List<String> values) {
        OptionalItemFilter optionalItemFilterList = new OptionalItemFilter(owner, id, name, accentColor);
        for (String value : values) {
            optionalItemFilterList.addEntry(value);
        }
        optionalItemFilterList.setDefaultValue(new ArrayList<OptionalLimitEntry>(optionalItemFilterList.getValue()));
        return (OptionalItemFilter)optionalItemFilterList.setDescription(description);
    }

    public static OptionalItemFilter create(Object owner, String id, String name, Color accentColor, String ... values) {
        return OptionalItemFilter.createWithDescription(owner, id, name, "List of Names/Strings", accentColor, Arrays.asList(values));
    }
