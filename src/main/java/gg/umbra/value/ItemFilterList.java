...
extends ListValue<ItemLimitData, ItemFilterList> {
    ...
    public static ItemFilterList createInternal(Object owner, String id, String name, Color accentColor, int defaultTotalStacks, List<ItemLimitData> entries) {
        ItemFilterList limitValue = new ItemFilterList(owner, id, name, accentColor, defaultTotalStacks, entries);
        limitValue.getValue().addAll(entries);
        return limitValue;
    }

    public ItemFilterList copyDefinition() {
        return new ItemFilterList(null, this.getId(), this.getName(), this.getAccentColor(), this.getDefaultTotalStacks(), this.getDefaultValue());
    }
    ...
    @Override
    public ItemFilterList copyValueDefinition() {
    ...
    public static ItemFilterList create(Object owner, String id, String name, Color accentColor, ItemLimitData ... entries) {
        return ItemFilterList.createInternal(owner, id, name, accentColor, -1, Arrays.asList(entries));
    }
    ...
    public ItemFilterList setIncludeOffhand(boolean includeOffhand) {
        this.includeOffhand = includeOffhand;
        return this;
    }

    public static ItemFilterList create(Object owner, String id, String name, Color accentColor, List<ItemLimitData> entries) {
        return ItemFilterList.createInternal(owner, id, name, accentColor, -1, entries);
    }
    ...
    private ItemFilterList(Object owner, String id, String name, Color accentColor, int defaultTotalStacks, List<ItemLimitData> entries) {
        super(owner, id, name, entries);
        this.accentColor = accentColor;
        this.defaultTotalStacks = defaultTotalStacks;
        this.setSuggestionProvider(new ItemSuggestionProvider());
    }
}
