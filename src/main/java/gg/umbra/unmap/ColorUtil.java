...
import gg.umbra.unmap.ColorContrastUtil;
...
public class ColorUtil {
    ...
    public static Color getAccentTextColor() {
        return ColorUtil.getContrastingGray(Umbra.INSTANCE.getClientSettings().guiColor.getMutableColor(), 45, 240);
    }
    ...
    public static Color selectContrastingGray(Color color, int darkGray, int lightGray, boolean ignoreRainbowMode) {
        double brightnessThreshold = !ignoreRainbowMode && Umbra.INSTANCE.getClientSettings().guiColor.isRainbowEnabled() ? 0.0 : 130.0;
