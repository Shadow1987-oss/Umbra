...
public class MovementInputHelper {
    ...
    public static void applyDirectionalMovement(double targetOffsetX, double targetOffsetZ,
        ...
        Umbra.debugLog("Vector " + strafeDelta[0] + " " + strafeDelta[1]
        ...
        if (strafeDistance < currentDistance) {
            KeyBinding leftKey = settings.x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg();
            KeyBinding rightKey = settings.g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3();
    ...
    public static void applyMovementToward(double targetOffsetX, double targetOffsetZ,
        ...
        ArrayList<KeyBinding> candidateKeys = new ArrayList<KeyBinding>(Arrays.asList(
                ...
                Minecraft.gameSettings().g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3(),
                Minecraft.gameSettings().s(),
                Minecraft.gameSettings().x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg()));
    ...
    private static boolean hasSupportingCollision(EntityPlayerSP player, double[] projectedPosition) {
        ...
        AxisAlignedBB bounds = ForgeVersion.MC_1_8_9.d()
                ? player.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl()
                : player.R$src$Lgg_umbra_wrapper_impl_AxisAlignedBB_$r19dfl().copy();
    ...
    public static boolean isPhysicalMovementInputActive() {
        GameSettings settings = Minecraft.gameSettings();
        return ClientSettings.isPhysicalKeyDown(settings.x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg())
                || ClientSettings.isPhysicalKeyDown(settings.g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3())
    ...
    public static void releaseMovementKeys() {
        GameSettings settings = Minecraft.gameSettings();
        setKeyPressed(settings.x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg(), false);
        setKeyPressed(settings.g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3(), false);
    ...
    public static void restorePhysicalInput(boolean includeSprint) {
        ...
        KeyBinding sneakKey = settings.d$src$Lgg_umbra_wrapper_impl_KeyBinding_$adn2z0();
    ...
    public static void releaseInput(boolean includeSprint) {
        ...
        setKeyPressed(settings.d$src$Lgg_umbra_wrapper_impl_KeyBinding_$adn2z0(), false);
