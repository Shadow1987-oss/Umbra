...
import gg.umbra.rotation.PlayerMouseRotationApplier;
...
public class ClickEngine {
    ...
    private final ToggleSetting itemLimitEnabled;
    private final OptionSetting randomizationMode;
    private final ToggleSetting jitterEnabled;
    private final RandomRangeSetting cpsRange;
    private final HackModule ownerModule;
    ...
    public ClickEngine(ClickButton button, RandomRangeSetting cpsRange, ToggleSetting itemLimitEnabled,
            ItemFilterList itemWhitelist, ToggleSetting holdToClick, OptionSetting randomizationMode,
            ToggleSetting jitterEnabled, HackModule ownerModule) {
    ...
    public RandomRangeSetting getCpsRange() {
    ...
    public void pressUseItem() {
        if (this.ownerModule != null) {
            KeyBindingHelper.updateKeyBinding(Minecraft.gameSettings().b$src$Lgg_umbra_wrapper_impl_KeyBinding_$1yi3362(),
                    true, true);
            return;
        }
    ...
    private KeyBinding getConfiguredKeyBinding() {
        ...
        return Minecraft.gameSettings().b$src$Lgg_umbra_wrapper_impl_KeyBinding_$1yi3362();
    }
    ...
    public int countOccupiedHotbarSlots(EntityPlayerSP player) {
        Object[] hotbarContents = Minecraft.thePlayer()
                .V$src$Lgg_umbra_wrapper_impl_InventoryPlayer_$erqak6().M();
