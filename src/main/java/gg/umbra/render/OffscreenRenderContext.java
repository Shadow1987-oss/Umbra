...
import gg.umbra.wrapper.impl.Framebuffer;
...
public class OffscreenRenderContext {
    ...
    public void renderOffscreenFrame() {
        ...
        try {
                        ...
                        entity = Minecraft.F();
                        entityRenderer = Minecraft.m$src$Lgg_umbra_wrapper_impl_EntityRenderer_$13begmf();
            ...
            Object ignored = Minecraft.umbraInstance;
            return;
        }
        finally {
