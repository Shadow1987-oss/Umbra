...
extends FrameHeaderComponent {
    ...
    public void h() {
        ...
        if (this.i.N$src$Lgg_umbra_module_Mod_$1rbaf6a() != null) {
            this.i.G(null);
        }
        ClientSettings.refreshCategoryHeader(this.i.G$src$Lgg_umbra_module_Category_$qyt4o7());
        for (GuiComponent guiComponent : this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().f()) {
    ...
    @Override
    public void u() {
        if (this.i.N$src$Lgg_umbra_module_Mod_$1rbaf6a() != null && ClientSettings.moduleSearchActive) {
            this.i.G(null);
        }
    }

    public void s(HackModule mod) {
        if (mod == null) {
            this.K.setLabelText("");
            return;
        }
    ...
    public void H() {
        ...
        if (this.i.N$src$Lgg_umbra_module_Mod_$1rbaf6a() != null && !ClientSettings.moduleSearchActive) {
            ...
            if (ClientSettings.moduleSearchActive) {
                ...
                boolean bl = this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().getBounds().Z(RenderUtils.h());
                if (((ModuleCategoryFrameHeader)this.getParentFrameComponent().j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc()).g$src$I$pd0er5() > 0) {
