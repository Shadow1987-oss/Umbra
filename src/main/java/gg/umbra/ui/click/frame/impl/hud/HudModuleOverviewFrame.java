...
import gg.umbra.ui.click.frame.impl.hud.HudModuleOverviewHeaderComponent;
...
extends Frame {
    ...
    public void c() {
        ...
        this.moduleList.M(this.G$src$D$1b2f02a(), this.n() + this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L());
    }
