...
import gg.umbra.ui.click.frame.impl.main.ClickGuiOverlayBackdropComponent;
import gg.umbra.ui.click.frame.impl.main.ClickGuiOverlayLayer;
import gg.umbra.ui.click.frame.impl.main.ClickGuiOverlayNavigationPanel;
import gg.umbra.ui.click.frame.impl.main.ClickGuiOverlayPlacement;
import gg.umbra.ui.click.frame.impl.main.ClickGuiOverlayPointPredicate;
...
import gg.umbra.ui.click.frame.impl.main.ClickGuiSectionSwitchMap;
...
final class ClickGuiOverlayController {
    ...
    private boolean lastLoggedVisibleState;
    ...
    void show(ClickGuiOverlaySpec clickGuiOverlaySpec) {
        ...
        gg.umbra.Umbra.debugLog("OVL show title=" + clickGuiOverlaySpec.getTitle() + " placement=" + clickGuiOverlayPlacement + " backdrop=" + clickGuiOverlaySpec.isBackdropEnabled() + " layer=" + this.layer);
    ...
    void close() {
        ...
        gg.umbra.Umbra.debugLog("OVL close open=" + bl2 + " progress=" + d + " spec=" + (this.activeSpec != null ? this.activeSpec.getTitle() : "null"));
        if (!bl2 && d <= 0.0) {
            return;
        }
        this.open = false;
    ...
    void updateAnimationState() {
        ...
        if (bl != this.lastLoggedVisibleState) {
            this.lastLoggedVisibleState = bl;
            gg.umbra.Umbra.debugLog("OVL state visible=" + bl + " open=" + this.open + " progress=" + d + " spec=" + (this.activeSpec != null ? this.activeSpec.getTitle() : "null") + " placement=" + this.placement);
        }
