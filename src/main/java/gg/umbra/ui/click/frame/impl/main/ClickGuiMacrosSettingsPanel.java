...
import gg.umbra.ui.click.frame.impl.main.ClickGuiMacrosNameInput;
import gg.umbra.ui.click.frame.impl.main.ClickGuiMacrosPreviewComponent;
import gg.umbra.ui.click.frame.impl.main.ClickGuiMacrosPrimaryBindCaptureTask;
import gg.umbra.ui.click.frame.impl.main.ClickGuiMacrosSecondaryBindCaptureTask;
import gg.umbra.ui.click.frame.impl.main.ClickGuiMacrosSettingsControlPanel;
import gg.umbra.ui.click.frame.impl.main.ClickGuiMacrosSettingsViewMode;
...
extends PanelComponent {
    ...
    private void saveChanges() {
        ...
        if (this.creatingNew) {
            ...
            Umbra.INSTANCE.getMacrosManager().addMacro(macro);
        } else {
            Macro macro = Macro.create(string).loadJson(jsonObject);
            Umbra.INSTANCE.getMacrosManager().removeMacro(this.macro);
            Umbra.INSTANCE.getMacrosManager().addMacro(macro);
        }
    ...
    private void buildActionButtons() {
        ...
        this.actionButtonsPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("widthwrap");
    ...
    private void buildControlPanel(double d) {
        ...
        this.settingsControlPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
