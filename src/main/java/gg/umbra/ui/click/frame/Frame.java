...
import gg.umbra.ui.click.frame.FrameCloseButtonClickHandler;
import gg.umbra.ui.click.frame.FrameComponent;
import gg.umbra.ui.click.frame.FrameHeaderComponent;
import gg.umbra.ui.click.frame.FrameStateSerializable;
import gg.umbra.ui.click.frame.FrameToolbarComponent;
...
implements FrameStateSerializable {
    ...
    public static GuiComponent[] c$src$ALgg_umbra_ui_click_component_GuiComponent_$19bazfq() {
        return I7;
    }

    public void j(boolean bl) {
        int n = (int)((double)Minecraft.J() / 4.0 / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor() - this.A() / 2.0);
        int n2 = (int)((double)Minecraft.h() / 4.0 / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor() - this.L() / 2.0);
    ...
    public double I$src$D$1eptndo() {
        return -(this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L() * 0.75);
    }
    ...
    @Override
    public double C() {
        return this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y();
    }
    ...
    public TextButton t$src$Lgg_umbra_ui_click_component_gui_TextButton_$p5ute3() {
        return this.IS;
    }
    ...
    public double g$src$D$1f6bh6i() {
        double d = (double)Minecraft.h() / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor();
        return d / 2.0 - this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L() * 0.5;
    }
    ...
    public double T$src$D$1evvdwn() {
        double d = (double)Minecraft.J() / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor();
    ...
    public void H() {
        ...
        super.H();
        if (this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() != null && this.IS.V$src$Z$1xhop3l()) {
    ...
    @Override
    public double x() {
        return this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C();
    }
    ...
    public void g(GuiMouseEvent guiMouseEvent) {
        if (this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() == null || !this.V$src$Z$1xhop3l()) {
            return;
        }
        if (this.I2 && guiMouseEvent.getAction().equals((Object)MouseButton.LEFT_CLICK) && this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().D(guiMouseEvent.getX(), guiMouseEvent.getY())) {
