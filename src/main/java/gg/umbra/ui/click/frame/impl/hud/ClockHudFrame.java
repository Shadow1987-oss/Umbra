...
extends HudModuleConfigFrameBase {
    ...
    private void renderAnalogClock() {
        ...
        SmoothFontRenderer timeFont = Umbra.INSTANCE.getFontManager().K(2.8, true);
        SmoothFontRenderer detailFont = Umbra.INSTANCE.getFontManager().K(0.85, true);
        this.drawClockTicks();
    ...
    private void renderDigitalClock() {
        SmoothFontRenderer timeFont = Umbra.INSTANCE.getFontManager().K(3.0, true);
        SmoothFontRenderer detailFont = Umbra.INSTANCE.getFontManager().K(1.0, true);
        String hourText = this.getHourText();
        String minuteText = this.getMinuteText();
