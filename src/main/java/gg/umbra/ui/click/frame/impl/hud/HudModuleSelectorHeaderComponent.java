...
import gg.umbra.ui.click.frame.impl.hud.HudModuleSelectorOpenConfigFrameClickHandler;
import gg.umbra.ui.click.frame.impl.hud.HudModuleSelectorOpenOverviewClickHandler;
...
extends FrameHeaderComponent {
    ...
    @Override
    public double A() {
        return this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().A();
    }
    ...
    public void H() {
        ...
        this.collapseButton.K(this.G$src$D$1b2f02a() + this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().A() - 10.0 - 8.0);
        this.collapseButton.S(this.n());
        this.collapseButton.Y(this.L());
        this.settingsButton.K(this.G$src$D$1b2f02a() + this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().A() - 30.0 - 8.0);
