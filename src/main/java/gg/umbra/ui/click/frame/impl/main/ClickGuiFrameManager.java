...
import gg.umbra.ui.click.frame.impl.hud.HudOverlaySelectorFrame;
...
extends FrameStackManager {
    ...
    public void A() {
        ...
        if (this.overlaySelector.V$src$Z$1xhop3l()) {
            ...
            this.overlaySelector.K((double)Minecraft.J() / 4.0 / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor() - this.overlaySelector.A() / 2.0);
            this.overlaySelector.S((double)Minecraft.h() / 2.0 / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor() - this.overlaySelector.L() - 5.0);
