...
import gg.umbra.ui.click.frame.ToggleableFrameHeaderToggleClickHandler;
...
extends CloseableFrameHeaderComponent {
    ...
    public void q(GuiComponent ... guiComponentArray) {
        this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().addChildren(guiComponentArray);
    ...
    public IconButtonComponent L$src$Lgg_umbra_ui_click_component_IconButtonComponent_$1i7gwfq() {
        return this.i;
    }
