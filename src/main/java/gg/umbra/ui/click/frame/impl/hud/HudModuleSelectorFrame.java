...
import gg.umbra.ui.click.frame.impl.hud.HudModuleGroupTabClickHandler;
import gg.umbra.ui.click.frame.impl.hud.HudModuleListPanel;
import gg.umbra.ui.click.frame.impl.hud.HudModuleSearchBox;
import gg.umbra.ui.click.frame.impl.hud.HudModuleSelectorHeaderComponent;
...
extends Frame {
    ...
    @Override
    public double L() {
        return (this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L() + 20.0) * 3.5 + 52.0;
    }
    ...
    public HudModuleSelectorFrame() {
        ...
        this.categoryBar.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("widthwrap");
    ...
    public void c() {
        ...
        moduleListPanel.M(this.G$src$D$1b2f02a(), this.n() + this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L() + this.searchBox.L());
        moduleListPanel.c();
