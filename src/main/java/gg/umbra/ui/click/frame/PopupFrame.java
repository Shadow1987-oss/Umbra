...
extends Frame {
    ...
    public GuiComponent V$src$Lgg_umbra_ui_click_component_GuiComponent_$jpbobc() {
        return this.FM;
    }
    ...
    public PopupFrame(GuiComponent guiComponent, GuiComponent guiComponent2) {
        ...
        this.Fm = this.FV = guiComponent.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa();
        while (this.Fm instanceof PopupFrame) {
            this.Fm = ((PopupFrame)this.Fm).Q$src$Lgg_umbra_ui_click_frame_Frame_$1y8ivjg();
        }
    ...
    public Frame X$src$Lgg_umbra_ui_click_frame_Frame_$1aw5qf9() {
        return this.Fm;
    }
    ...
    public Frame Q$src$Lgg_umbra_ui_click_frame_Frame_$1y8ivjg() {
        return this.FV;
    }

    public GuiComponent D$src$Lgg_umbra_ui_click_component_GuiComponent_$srx612() {
        return this.FI;
    }
