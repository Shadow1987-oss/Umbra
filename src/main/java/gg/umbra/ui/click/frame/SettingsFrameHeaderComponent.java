...
import gg.umbra.ui.click.frame.SettingsFrameHeaderCollapseClickListener;
import gg.umbra.ui.click.frame.SettingsFrameHeaderToggleClickListener;
...
extends FrameHeaderComponent {
    ...
    public IconButtonComponent x$src$Lgg_umbra_ui_click_component_IconButtonComponent_$x1h5th() {
        return this.Q;
    }
    ...
    private void A$src$V$18zygv7() {
        ...
        this.I.setOverrideColor(this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().y$src$Z$1f55jvh() ? SettingsFrameHeaderComponent.J.f : SettingsFrameHeaderComponent.J.W.darker());
        this.I.K(this.G$src$D$1b2f02a() + this.A() - 20.0);
        this.I.S(this.n() + 1.0);
        this.I.Y(this.L());
        this.I.o(10.0);
        this.Q.setOverrideColor(this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0() instanceof CollapsibleFrame && !((CollapsibleFrame)((Object)this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0())).q() ? SettingsFrameHeaderComponent.J.f : null);
    ...
    @Override
    public void I() {
        if (this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0() instanceof CollapsibleFrame && !((CollapsibleFrame)((Object)this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0())).q()) {
            ((CollapsibleFrame)((Object)this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0())).w();
        }
    }
