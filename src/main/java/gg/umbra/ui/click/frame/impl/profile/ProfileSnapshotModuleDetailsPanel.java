...
extends PanelComponent {
    ...
    public ProfileSnapshotModuleDetailsPanel() {
        ...
        this.settingsPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        ...
        this.headerPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().Q(true);
