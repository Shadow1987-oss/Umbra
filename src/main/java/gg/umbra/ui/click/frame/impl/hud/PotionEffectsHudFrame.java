...
extends HudModuleConfigFrameBase {
    ...
    public void renderHudContent() {
        ...
        SmoothFontRenderer smoothFontRenderer = Umbra.INSTANCE.getFontManager().K(0.85, true);
        if (I18n.getLanguage().isUnicode()) {
            smoothFontRenderer = Umbra.INSTANCE.getFontManager().b(FontFamily.NOTO, 0.85f, false);
        }
