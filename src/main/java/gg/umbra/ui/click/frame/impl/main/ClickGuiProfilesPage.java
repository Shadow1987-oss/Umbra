...
import gg.umbra.event.impl.ProfileListMutationEvent;
import gg.umbra.ui.click.animation.DoubleAnimation;
...
import gg.umbra.ui.click.frame.impl.main.ClickGuiPageBase;
import gg.umbra.ui.click.frame.impl.main.ClickGuiProfileCardComponent;
import gg.umbra.ui.click.frame.impl.main.ClickGuiProfileHeaderComponent;
import gg.umbra.ui.click.frame.impl.profile.ProfileCardActionState;
import gg.umbra.ui.click.frame.impl.profile.ProfileListEntryMetadataComponent;
import gg.umbra.ui.click.frame.impl.profile.ProfileListEntryOpenButtonComponent;
import gg.umbra.ui.click.frame.impl.profile.ProfileModuleSnapshotListComponent;
import gg.umbra.ui.click.frame.impl.profile.ProfileModuleSnapshotListStyle;
import gg.umbra.ui.click.frame.impl.profile.ProfilesPageEmptyStateComponent;
import gg.umbra.ui.click.frame.impl.profile.ProfilesPageOverlayController;
import gg.umbra.ui.click.frame.impl.profile.ProfilesPageRefreshListener;
import gg.umbra.ui.click.frame.impl.profile.ProfilesSettingsFrameState;
...
implements EventListener {
    ...
    private void beginCreateProfile() {
        ...
        this.draftProfile = new Profile(profile.getName(), Umbra.VERSION);
        ...
        Umbra.INSTANCE.getProfilesManager().switchProfile(this.draftProfile);
    ...
    private void cancelCreateProfile() {
        ...
        if (profile != null && profile.isDraft()) {
            Umbra.INSTANCE.getProfilesManager().setActiveProfile(this.previousActiveProfile != null ? this.previousActiveProfile : this.displayedActiveProfile);
        }
    ...
    private void populateProfileSidecar(Profile profile, PanelComponent panelComponent) {
        ...
        panelComponent2.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("widthwrap");
    ...
    private void renderExistingProfile(Profile profile, double d, double d2) {
        ...
        double d3 = d * 2.0;
        double d4 = this.mainPanel.L() - this.mainPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y() - d3;
    ...
    private void renderSidebar() {
        ...
        this.getSidebarHeader().h(new SpacerComponent(this.getSidebarHeader().A() - this.getSidebarHeader().l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C() - this.newProfileButton.A() - ((GuiComponent)object).A() - 8.0 - 1.0, 0.0), new Object[0]);
        ...
        this.profileList = this.createFlowLayout(this.getSidebarContent().A(), this.getSidebarContent().L() - this.getSidebarContent().l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y() - 21.0);
        this.profileList.F(FrameScrollbarPlacement.OUTSIDE);
        this.profileList.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        ...
        object = Umbra.INSTANCE.getProfilesManager().getActiveProfile();
    ...
    private void createProfile() {
        ...
        Profile profile = Umbra.INSTANCE.getProfilesManager().getProfileByName(string);
        if (profile != null) {
            return;
        }
        ...
        Umbra.INSTANCE.getProfilesManager().addProfile(this.draftProfile, true);
        Umbra.INSTANCE.getProfilesManager().setActiveProfile(this.draftProfile);
        this.draftProfile = null;
        this.previousActiveProfile = null;
        this.createNameInput = null;
        this.draftProfileCard = null;
    ...
    private void renderCreateProfile(Profile profile, double d, double d2) {
        ...
        double d3 = this.mainPanel.L() - this.mainPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y() - panelComponent.L() - d * 5.0 + 1.0;
        d3 = Math.max(0.0, d3);
    ...
    private void refreshProfileList() {
        ...
        for (Profile profile2 : Umbra.INSTANCE.getProfilesManager().getProfiles()) {
