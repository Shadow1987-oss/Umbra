...
import gg.umbra.ui.click.frame.impl.quickactions.QuickActionRowComponent;
import gg.umbra.ui.click.frame.impl.quickactions.QuickActionsHeaderCloseCallback;
...
extends Frame {
    ...
    public QuickActionRowComponent m$src$Lgg_umbra_ui_click_frame_impl_quickactions_QuickA$1kmfigl() {
        return this.mF;
    }
    ...
    public QuickActionsFrame() {
        ...
        publicProfilesFrameHeaderActionComponent.O$src$Lgg_umbra_ui_click_component_SquareIconButtonComp$z3cp96().clearClickListeners();
        publicProfilesFrameHeaderActionComponent.O$src$Lgg_umbra_ui_click_component_SquareIconButtonComp$z3cp96().addClickListener(new QuickActionsHeaderCloseCallback(this));
    ...
    public QuickActionRowComponent Y$src$Lgg_umbra_ui_click_frame_impl_quickactions_QuickA$p4ezt5() {
        return this.mX;
    }
    ...
    public QuickActionRowComponent N$src$Lgg_umbra_ui_click_frame_impl_quickactions_QuickA$1smecqc() {
        return this.mP;
    }
    ...
    public QuickActionRowComponent E$src$Lgg_umbra_ui_click_frame_impl_quickactions_QuickA$1snij4t() {
        return this.mW;
    }
