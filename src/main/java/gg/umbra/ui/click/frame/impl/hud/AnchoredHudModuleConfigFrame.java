...
import gg.umbra.ui.click.frame.impl.hud.AnchoredHudModuleConfigCloseHeaderButton;
import gg.umbra.ui.click.frame.impl.hud.HudModuleFrameOpenConfigClickHandler;
...
extends Frame {
    ...
    public void repositionToAnchor() {
        ...
        if (anchor.G$src$D$1b2f02a() != this.previousAnchorX || anchor.n() != this.previousAnchorY) {
            ...
            if (frameComponent.k$src$Z$if6xeb()) {
                ...
                anchoredY = Math.max(anchoredY, frameComponent.n() + frameComponent.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L());
            }
    ...
    @Override
    public void Y() {
        PublicProfilesFrameHeaderActionComponent publicProfilesFrameHeaderActionComponent = (PublicProfilesFrameHeaderActionComponent)this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc();
        ...
        for (GuiComponent guiComponent : this.f()) {
            if (guiComponent == this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() || guiComponent == this.noSettingsLabel) continue;
            bl = true;
            break;
        }
    ...
    public AnchoredHudModuleConfigFrame(T t) {
        ...
        anchoredHudModuleConfigCloseHeaderButton.O$src$Lgg_umbra_ui_click_component_SquareIconButtonComp$z3cp96().getClickListeners().clear();
        anchoredHudModuleConfigCloseHeaderButton.O$src$Lgg_umbra_ui_click_component_SquareIconButtonComp$z3cp96().addClickListener(new HudModuleFrameOpenConfigClickHandler(this));
