...
import gg.umbra.wrapper.impl.Biome;
import gg.umbra.wrapper.impl.BlockPos;
import gg.umbra.wrapper.impl.Chunk;
import gg.umbra.wrapper.impl.ChunkWorldBridge;
...
extends HudModuleConfigFrameBase {
    ...
    private void renderVerticalLayout() {
        SmoothFontRenderer labelFont = Umbra.INSTANCE.getFontManager().K(0.7, true);
        SmoothFontRenderer valueFont = Umbra.INSTANCE.getFontManager().K(1.1, true);
    ...
    private void renderHorizontalLayout() {
        SmoothFontRenderer labelFont = Umbra.INSTANCE.getFontManager().K(0.75, true);
        SmoothFontRenderer valueFont = Umbra.INSTANCE.getFontManager().K(1.2, true);
