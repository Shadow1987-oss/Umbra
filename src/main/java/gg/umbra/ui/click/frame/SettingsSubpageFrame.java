...
import gg.umbra.ui.click.frame.FrameToolbarEntry;
import gg.umbra.ui.click.frame.OutlinedFrameBase;
import gg.umbra.ui.click.frame.SettingsSectionComponent;
import gg.umbra.ui.click.frame.SettingsSectionPopupOpenClickHandler;
import gg.umbra.ui.click.frame.SettingsSubpageFrameCollapseClickHandler;
import gg.umbra.ui.click.frame.SettingsSubpageFrameRefreshClickHandler;
...
implements CollapsibleFrame {
    ...
    public SettingsSubpageFrame(String string, String string2, boolean bl, boolean bl2) {
        ...
        this.Y(this.fP);
        if (bl) {
            this.i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6().addEntry(new FrameToolbarEntry(this.fy, false));
        }
        if (bl2) {
            this.i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6().addAction(this.fE);
            this.i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6().getCloseButton().addClickListener(this::p);
        }
        this.i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6().getNavigationButton().addClickListener(this::K$src$V$qg5iru);
    }

    public FrameToolbarComponent i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6() {
        return this.fP;
    }

    public IconButtonComponent q$src$Lgg_umbra_ui_click_component_IconButtonComponent_$1bvowkh() {
        return this.fE;
    }
    ...
    public CenteredPopupFrame H$src$Lgg_umbra_ui_click_frame_CenteredPopupFrame_$1qmombx() {
        return this.fu;
    }
    ...
    public void p() {
        if (this.fu == null) {
            ...
            try {
                ...
                this.fu.n(18.0);
                this.fu.o(d);
                this.fh.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
                this.fu.l$src$V$1mibm4x();
