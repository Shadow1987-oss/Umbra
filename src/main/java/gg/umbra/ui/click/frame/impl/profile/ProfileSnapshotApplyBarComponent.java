...
extends FlowLayoutComponent {
    ...
    public ProfileSnapshotApplyBarComponent(ProfileSnapshot snapshot, double width, boolean resetAction) {
        ...
        this.actionLabel.addClickListener(() -> {
            ...
            if (resetAction) {
                ConfirmationDialogComponent.showStandard(this.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa(), "Are you sure you want to reset all settings?", "Reset", "reset_circle", () -> this.handleResetConfirmed(profileSnapshotFrame));
            } else {
