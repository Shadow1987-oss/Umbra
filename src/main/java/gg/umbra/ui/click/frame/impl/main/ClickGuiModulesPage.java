...
import gg.umbra.ui.click.component.FriendModuleInteractiveComponent;
...
import gg.umbra.ui.click.component.value.ValueComponentMode;
...
extends ClickGuiPageBase {
    ...
    private void renderCurrentView() {
        ...
        if (this.viewMode == ClickGuiModuleViewMode.DASHBOARD) {
    ...
    private void renderDashboardView() {
        SimpleTextLabelComponent sectionLabel = new SimpleTextLabelComponent("Categories", 0.9, ClickGuiModulesPage.J.A);
        sectionLabel.setBold(true);
        sectionLabel.setOffsetX(0.0f);
        sectionLabel.setExtraHeight(0);
        this.getMainContent().h(sectionLabel, new Object[0]);
        this.getMainContent().h(new SpacerComponent(0.0, 6.0), new Object[0]);
        ClickGuiContentPanel dashboardContent = new ClickGuiContentPanel(this.getAvailableContentWidth(), this.getMainContent().L() - this.getMainContent().l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y() - 1.0);
        dashboardContent.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        dashboardContent.setShowDisabledOverlay(false);
        dashboardContent.t(dashboardContent.L());
        dashboardContent.F(FrameScrollbarPlacement.OUTSIDE);
        dashboardContent.setResponsiveWidthEnabled(true);
        dashboardContent.E(true);
        int n = 0;
        for (Category category : Category.values()) {
            if (category == Category.NONE || category == Category.OTHER) continue;
            ClickGuiCategoryCardComponent clickGuiCategoryCardComponent = new ClickGuiCategoryCardComponent(category);
            clickGuiCategoryCardComponent.o(dashboardContent.A() / 2.0);
            clickGuiCategoryCardComponent.addClickListener(() -> this.openDashboardCategory(clickGuiCategoryCardComponent.getCategory()));
            dashboardContent.h(new PaddedComponent(0.0, 3.0, 4.0, 4.0, clickGuiCategoryCardComponent), n % 2 == 1 ? "wrap" : "widthwrap");
            ++n;
        }
        dashboardContent.H(true);
        this.getMainContent().h(dashboardContent, new Object[0]);
    }

    private void openDashboardCategory(Category category) {
        this.lambda$renderCategoryButtons$4(category);
    }

    private Boolean lambda$renderHomeNavSelected() {
        return this.viewMode == ClickGuiModuleViewMode.DASHBOARD;
    }

    private void lambda$renderHomeNavClick() {
        if (this.viewMode != ClickGuiModuleViewMode.DASHBOARD) {
            this.viewMode = ClickGuiModuleViewMode.DASHBOARD;
    ...
    private void openModuleSettings(HackModule mod, ClickGuiModuleCardComponent clickGuiModuleCardComponent) {
    ...
    private static int lambda$filterModuleButtons$14(HackModule mod, HackModule mod2) {
    ...
    private static String lambda$openModuleSettings$24(HackModule mod) {
    ...
    private static void lambda$openModuleSettings$23(HackModule mod, ClickGuiModulesSidecarPanel clickGuiModulesSidecarPanel, ClickGuiModuleCardComponent clickGuiModuleCardComponent) {
    ...
    private void rebuildModuleCards(ClickGuiContentPanel clickGuiContentPanel, boolean bl) {
        ...
        if (bl2) {
            ArrayList<HackModule> arrayList = new ArrayList<>();
            if (bl) {
                ArrayList<HackModule> arrayList2 = Umbra.INSTANCE.getHackManager().getActiveModuleList();
                for (HackModule object4 : arrayList2) {
                    HudModule hudModule;
                ...
                arrayList = new ArrayList<HackModule>(Umbra.INSTANCE.getHackManager().collectMods());
            ...
            for (HackModule mod : arrayList) {
                ...
                clickGuiModuleCardComponent.o(this.reorderingFavorites ? clickGuiContentPanel.A() : clickGuiContentPanel.A() / 2.0);
                ...
                clickGuiContentPanel.h(this.reorderingFavorites ? new PaddedComponent(0.0, 3.0, 0.0, 0.0, clickGuiModuleCardComponent) : new PaddedComponent(0.0, 3.0, 4.0, 4.0, clickGuiModuleCardComponent), this.reorderingFavorites ? "wrap" : (n % 2 == 1 ? "wrap" : "widthwrap"));
                ++n;
            }
        ...
        ArrayList<HackModule> arrayList = new ArrayList<>();
        if (bl) {
            ArrayList<HackModule> arrayList3 = Umbra.INSTANCE.getHackManager().getActiveModuleList();
            for (HackModule mod : arrayList3) {
                if (!(mod instanceof HudModule)) continue;
                HudModule hudModule = (HudModule)mod;
                arrayList.add(hudModule);
            }
        } else if (this.selectedCategory == Category.FAVORITES) {
            arrayList = new ArrayList<HackModule>(Umbra.INSTANCE.getModuleProfileMetadataCodec().getSelectedModules());
        } else {
            arrayList = new ArrayList<HackModule>(Umbra.INSTANCE.getHackManager().collectMods());
            arrayList.removeIf(ClickGuiModulesPage::lambda$filterModuleButtons$11);
            arrayList.removeIf(ClickGuiModulesPage::lambda$filterModuleButtons$12);
    ...
    private static boolean lambda$filterModuleButtons$12(HackModule mod) {
    ...
    private static Integer lambda$renderCategoryButtons$3(Category category) {
        return Umbra.INSTANCE.getHackManager().countEnabledModules(category);
    }
    ...
    private static boolean lambda$filterModuleButtons$13(String string, HackModule mod) {
    ...
    private void lambda$openModuleSettings$25(HackModule mod, PanelComponent panelComponent) {
    ...
    private void renderModuleView(boolean bl) {
        ...
        LabeledTextInputComponent labeledTextInputComponent = bl ? (this.legitSearchInput = new ClickGuiModulesFilterInputComponent(this, "BlockFinder legit modules...")) : (this.moduleSearchInput = new ClickGuiModulesSearchInputComponent(this, "BlockFinder modules..."));
        ...
        this.getMainContent().h(new SpacerComponent(0.0, 6.0), new Object[0]);
        if (bl) {
            this.legitContent = new ClickGuiContentPanel(this.getMainContent().A(), this.getMainContent().L() - this.getMainContent().l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y() - 1.0);
            ...
            this.moduleContent = new ClickGuiContentPanel(this.getAvailableContentWidth(), this.getMainContent().L() - this.getMainContent().l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y() - 1.0);
            this.moduleContent.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
    ...
    private static boolean lambda$filterModuleButtons$11(HackModule mod) {
    ...
    private static Integer lambda$renderCategoryButtons$2() {
        return Umbra.INSTANCE.getModuleProfileMetadataCodec().getVisibleModuleCount();
    }

    private void renderNavigation() {
        this.getSidebarContent().removeMarkedChildren();
        FriendModuleInteractiveComponent homeNavItem = new FriendModuleInteractiveComponent("Home", null, this::lambda$renderHomeNavSelected, null, null);
        homeNavItem.addClickListener(this::lambda$renderHomeNavClick);
        this.getSidebarContent().h(new PaddedComponent(0.0, 3.0, 0.0, 0.0, homeNavItem), new Object[0]);
    ...
    private void populateSettings(HackModule mod, PanelComponent panelComponent) {
        ...
        for (Value<?, ?> value : mod.getValues()) {
            ...
            if (value.getParent() != null) {
                ToggleSetting booleanValue = value.getParent() instanceof ToggleSetting ? (ToggleSetting)value.getParent() : null;
