...
extends HudModuleFrameBase {
    ...
    private final ToggleSetting renderBackgroundSetting;
    ...
    protected void closeHudFrame() {
        ...
        ((HackModule)this.getModule()).setEnabled(false);
    ...
    protected void openAnchoredSettings() {
        ...
        anchoredHudModuleConfigFrame.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().setVisible(true);
    ...
    public HudModuleConfigFrameBase(Class<T> clazz) {
        super(clazz.getName());
        this.module = (T)Umbra.INSTANCE.getHackManager().getMod(clazz);
        ...
        this.renderBackgroundSetting = ToggleSetting.create(this.module, "Render background", true);
        ((HackModule)this.module).P(this.renderBackgroundSetting, new MinecraftVersionConstraint[0]);
    ...
    public String getEditorLabel() {
        if (this.module != null && ((HackModule)this.module).getName() != null && !((HackModule)this.module).getName().isEmpty()) {
            return ((HackModule)this.module).getName();
        }
