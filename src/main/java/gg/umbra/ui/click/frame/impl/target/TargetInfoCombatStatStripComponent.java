...
import gg.umbra.ui.click.frame.impl.target.TargetInfoStatStripComponent;
...
extends TargetInfoStatStripComponent {
    ...
    public void H() {
        ...
        SmoothFontRenderer smoothFontRenderer = Umbra.INSTANCE.getFontManager().K(0.9f, true);
