...
import gg.umbra.ui.click.frame.impl.FrameMacrosEditorRefreshFrameMouseListener;
...
extends InteractiveComponent {
    ...
    public void H() {
        ...
        if (this.qn) {
            ...
            this.qz.o(d7 - 6.0);
            d6 += this.qz.L();
            if (this.qz.getToggleSetting().getEffectiveValue().booleanValue()) {
    ...
    public void g(GuiMouseEvent guiMouseEvent) {
        if (this.qQ.l$src$Lgg_umbra_ui_click_frame_impl_FrameMacrosEditor_$1712c36() != null && this.qQ.l$src$Lgg_umbra_ui_click_frame_impl_FrameMacrosEditor_$1712c36().equals(this) && !this.getBounds().J(guiMouseEvent.getX(), guiMouseEvent.getY())) {
            if (!this.v.V$src$Z$1xhop3l()) {
                this.qQ.X(null);
                return;
            }
    ...
    @Override
    public double C() {
        return this.qn ? (this.qz.getToggleSetting().getEffectiveValue().booleanValue() ? 120.0 : 90.0) : 18.0;
    }
    ...
    private void lambda$setInitialMode$5() {
        ...
        Umbra.INSTANCE.getMacrosManager().addMacro(this.q1);
        this.setVisible(false);
        this.qQ.X(null);
    }
