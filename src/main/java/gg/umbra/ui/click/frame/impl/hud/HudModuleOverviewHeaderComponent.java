...
import gg.umbra.ui.click.frame.impl.hud.HudModuleOverviewOpenSelectorClickHandler;
...
extends FrameHeaderComponent {
    ...
    public void H() {
        ...
        double d = smoothFontRenderer.d(this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().getName());
