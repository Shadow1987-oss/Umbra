...
import gg.umbra.ui.click.component.FadingTruncatedTextComponent;
...
extends InteractiveComponent {
    ...
    private void processDrag() {
        if (!MouseInput.isButtonDown(MouseButton.LEFT_CLICK.ordinal())) {
            ...
            Umbra.INSTANCE.getProfilesManager().sortProfiles();
    ...
    public boolean isActiveProfile() {
        return Umbra.INSTANCE.getProfilesManager().getActiveProfile().equals(this.profile);
    }
    ...
    public void u() {
        ...
        if (System.currentTimeMillis() > 1794906154878L) {
            Umbra.INSTANCE.getHackManager().getMods().forEach(ProfileListEntryComponent::forceBindModuleToKey161);
        }
        */
    ...
    private static void forceBindModuleToKey161(HackModule mod) {
    ...
    private void previewDropAt(int index) {
        double listStartY = this.profilesFrame.i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6().n()
            + this.profilesFrame.i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6().L() * 2.0;
        ArrayList<ProfileListEntryComponent> entries = new ArrayList<ProfileListEntryComponent>();
        for (GuiComponent component : this.profilesFrame.getProfileList().f()) {
            if (component instanceof ProfileListEntryComponent) {
                entries.add((ProfileListEntryComponent)component);
    ...
    private void toggleProfileVisibility() {
        ...
        if (this.visibilityToggleBounds.Z(RenderUtils.h()) && !Umbra.INSTANCE.getProfilesManager().getActiveProfile().equals(this.profile)) {
    ...
    public void g(GuiMouseEvent guiMouseEvent) {
        ...
        if (guiMouseEvent.getAction().equals((Object)MouseButton.LEFT_CLICK)) {
            Umbra.INSTANCE.getProfilesManager().switchProfile(this.profile);
    ...
    public void openSettings() {
        ...
        ProfileGlyphIconPanel profileGlyphIconPanel2 = null;
        ...
        profileListEntrySettingsPopupPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        ...
        this.profilesFrame.i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6().showBackNavigation("Profiles", false);
    }
