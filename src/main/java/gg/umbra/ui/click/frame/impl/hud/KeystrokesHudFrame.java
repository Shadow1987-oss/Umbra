...
import gg.umbra.ui.click.frame.impl.hud.KeystrokesCpsCounterComponent;
import gg.umbra.ui.click.frame.impl.hud.KeystrokesKeyComponent;
import gg.umbra.ui.click.frame.impl.hud.KeystrokesMouseButtonComponent;
...
extends HudModuleConfigFrameBase {
    ...
    private void drawKey(KeystrokesKeyComponent key, double x, double y,
        ...
        SmoothFontRenderer smoothFontRenderer = Umbra.INSTANCE.getFontManager().W(0.9, false);
    ...
    public KeystrokesHudFrame() {
        ...
        this.leftKey = new KeystrokesKeyComponent(this, this.gameSettings.x$src$Lgg_umbra_wrapper_impl_KeyBinding_$1cf7isg());
        this.rightKey = new KeystrokesKeyComponent(this, this.gameSettings.g$src$Lgg_umbra_wrapper_impl_KeyBinding_$qqn5n3());
        this.leftMouseButton = new KeystrokesMouseButtonComponent(this, this.gameSettings.F());
        this.rightMouseButton = new KeystrokesMouseButtonComponent(this, this.gameSettings.b$src$Lgg_umbra_wrapper_impl_KeyBinding_$1yi3362());
