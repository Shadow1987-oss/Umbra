...
import gg.umbra.ui.click.frame.impl.hud.HudModuleConfigFrameCloseClickHandler;
...
extends Frame {
    ...
    public HudModule getSelectedModule() {
        ...
        return (HudModule)Umbra.INSTANCE.getHackManager().getMod(this.selectedModule.getClass());
    }
