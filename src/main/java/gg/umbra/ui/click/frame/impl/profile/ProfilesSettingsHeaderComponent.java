...
import gg.umbra.ui.click.frame.impl.profile.ProfilesHeaderApplyPendingProfileClickHandler;
import gg.umbra.ui.click.frame.impl.profile.ProfilesHeaderShowActiveRowsClickHandler;
import gg.umbra.ui.click.frame.impl.profile.ProfilesHeaderShowAllRowsClickHandler;
...
extends ToggleableFrameHeaderComponent {
    ...
    public void H() {
        ...
        if (this.profilesFrame.getActivePopup() != null) {
            this.Y(false);
            this.L$src$Lgg_umbra_ui_click_component_IconButtonComponent_$1i7gwfq().setVisible(false);
        ...
        if (this.profilesFrame.isShowingAllProfiles()) {
            ...
            this.L$src$Lgg_umbra_ui_click_component_IconButtonComponent_$1i7gwfq().setVisible(true);
            this.doneButton.setVisible(false);
            ...
            int hiddenProfileCount = (int)Umbra.INSTANCE.getProfilesManager().getProfiles().stream().filter(ProfilesSettingsHeaderComponent::isHiddenProfile).count();
