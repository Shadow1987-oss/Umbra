...
extends ClickGuiPanelBase {
    ...
    protected FlowLayoutComponent createFlowLayout(double width, double height) {
        ...
        flowLayoutComponent.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
    ...
    private ClickGuiContentPanel createContentPanel(double width, double height) {
        ...
        clickGuiContentPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
    ...
    private ClickGuiContentPanel createHeaderPanel(double width) {
        ...
        clickGuiContentPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("widthwrap");
    ...
    public ClickGuiPageBase(double d, double d2, double d3, double d4, String string) {
        ...
        this.sidebarContent = this.createContentPanel(d3, this.sidebarContainer.L() - this.sidebarContainer.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y() - 2.0);
        ...
        this.mainWidth = this.A() - this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C() - 20.0 + d4;
