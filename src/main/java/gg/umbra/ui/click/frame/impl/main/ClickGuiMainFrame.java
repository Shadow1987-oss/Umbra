...
import gg.umbra.ui.click.frame.impl.main.ClickGuiMainFrameHeader;
import gg.umbra.ui.click.frame.impl.main.ClickGuiMainFrameTransitionComponent;
import gg.umbra.ui.click.frame.impl.main.ClickGuiModulesPage;
import gg.umbra.ui.click.frame.impl.main.ClickGuiOverlayController;
...
import gg.umbra.ui.click.frame.impl.main.ClickGuiPanelBase;
import gg.umbra.ui.click.frame.impl.main.ClickGuiProfilesPage;
import gg.umbra.ui.click.frame.impl.main.ClickGuiSection;
...
extends OutlinedFrameBase {
    ...
    public ClickGuiMainFrame() {
        ...
        this.contentPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("widthwrap");
    ...
    public Category s$src$Lgg_umbra_module_Category_$154whg1() {
    ...
    private ClickGuiPanelBase createPage(ClickGuiSection clickGuiSection) {
        ...
        switch (clickGuiSection) {
            ...
            case FRIENDS: {
                clickGuiPageBase = new ClickGuiFriendsPage(this, this.contentPanel.A(), this.contentPanel.L(), 186.0);
                break;
            }
            default: {
                return null;
