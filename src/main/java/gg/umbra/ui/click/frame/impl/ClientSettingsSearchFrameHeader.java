...
import gg.umbra.ui.click.component.input.ClientSettingsSearchInputComponent;
...
import gg.umbra.ui.click.frame.impl.ClientSettingsSearchFrameHeaderInputChangeListener;
import gg.umbra.ui.click.frame.impl.ClientSettingsSearchFrameHeaderSearchFocusClickHandler;
import gg.umbra.ui.click.frame.impl.ClientSettingsSearchFrameHeaderSettingsToggleClickHandler;
...
extends FrameHeaderComponent {
    ...
    public void H() {
        ...
        if (this.i) {
            ...
            this.o.o(0.0);
            float f = 6.5f;
            float f2 = (float)ImageRenderer.getImageWidth("umbralogo") / f;
            float f3 = (float)ImageRenderer.getImageHeight("umbralogo") / f;
            float f4 = (float)ImageRenderer.getImageWidth("v4") / f;
            float f5 = (float)ImageRenderer.getImageHeight("v4") / f;
            ImageRenderer.drawImage(Color.WHITE, (float)this.G$src$D$1b2f02a() + 6.0f, (float)this.n() + 5.0f, "umbralogo", f2, f3, false);
        ...
        this.R.setOverrideColor(this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().y$src$Z$1f55jvh() ? ClientSettingsSearchFrameHeader.J.f : null);
        this.R.K(d);
        this.R.S(this.n());
        this.R.Y(this.L());
        d -= 13.0;
