...
import gg.umbra.ui.click.frame.impl.hud.HudModuleFrameBaseCloseClickHandler;
import gg.umbra.ui.click.frame.impl.hud.HudModuleFrameCloseClickHandler;
...
extends Frame {
    ...
    public double getMaximumY() {
        return Math.floor((double)Minecraft.h() / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor() / 2.0 - this.L() - 2.5);
    }

    public double getMaximumX() {
        return Math.floor((double)Minecraft.J() / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor() / 2.0 - this.A() - 2.5);
    }
