...
implements CollapsibleFrame {
    ...
    public double getComponentHeight() {
        ...
        for (GuiComponent guiComponent : this.f()) {
            if (!guiComponent.V$src$Z$1xhop3l()
                    ...
                    || guiComponent.equals(this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc())) continue;
    ...
    private void hideHeaderForHudMode() {
        if (!this.headerHiddenForHudMode
                && this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() != null) {
            this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().setVisible(false);
    ...
    public HudSettingsFrameBase(String title, String frameId) {
        ...
        this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M(WRAP_LAYOUT);
    ...
    protected boolean isPublicProfilePreview() {
        return this.isManagedByClickGui() && Umbra.INSTANCE.getPublicProfileSettings().centralGuiStyle.isSelected();
    }
    ...
    private void restoreHeaderOutsideHudMode() {
        if (this.headerHiddenForHudMode
                && this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() != null) {
            this.restoreSettingComponents();
            this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().setVisible(true);
    ...
    public double L() {
        ...
        return this.q() ? this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L() : super.L();
    }
