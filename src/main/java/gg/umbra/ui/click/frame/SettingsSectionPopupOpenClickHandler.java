...
implements GuiClickListener {
    ...
    public void onPrimaryClick() {
        double d = this.P.A();
        PanelComponent panelComponent = new PanelComponent(d, this.P.L() - this.P.i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6().L());
        ...
        panelComponent.t(this.P.L() - this.P.i$src$Lgg_umbra_ui_click_frame_FrameToolbarComponent_$gnpgc6().L());
        panelComponent.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M(c);
        ...
        for (GuiComponent guiComponent : this.a.n$src$ALgg_umbra_ui_click_component_GuiComponent_$ay9kg5()) {
