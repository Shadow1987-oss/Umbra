...
import gg.umbra.ui.click.layout.WrappingFlowLayout;
...
extends FrameComponent {
    ...
    @Override
    public double x() {
        double d = this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C();
        Double d2 = this.qE;
        if (d2 != null) {
    ...
    public ScrollableFrameComponent(double d) {
        this.qP.o(d);
        this.N(this.qP);
        this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M(eb);
    }
