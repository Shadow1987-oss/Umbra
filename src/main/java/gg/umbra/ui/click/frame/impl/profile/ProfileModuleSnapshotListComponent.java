...
import gg.umbra.ui.click.frame.impl.profile.ProfileModuleSnapshotRowComponent;
...
extends FlowLayoutComponent {
    ...
    public ProfileModuleSnapshotListComponent(Profile profile, double width, double listHeight) {
        ...
        this.moduleList.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M(false);
    ...
    @Override
    public void u() {
        if (!this.profile.equals(Umbra.INSTANCE.getProfilesManager().getActiveProfile())) {
            return;
        }
