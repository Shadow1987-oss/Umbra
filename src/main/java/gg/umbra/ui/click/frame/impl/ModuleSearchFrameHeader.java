...
import gg.umbra.ui.click.component.HalfScaleIconButtonComponent;
...
import gg.umbra.ui.click.frame.impl.ModuleSearchFrameHeaderRefreshListener;
import gg.umbra.ui.click.frame.impl.hud.HudModuleListPanel;
import gg.umbra.ui.click.frame.impl.hud.HudModuleOverviewListFrame;
...
extends FrameHeaderComponent {
    ...
    public IconButtonComponent G$src$Lgg_umbra_ui_click_component_IconButtonComponent_$1pnwa51() {
        return this.v;
    }
    ...
    public ModuleSearchInputComponent A$src$Lgg_umbra_ui_click_component_input_ModuleSearchIn$1efzz7n() {
        return this.K;
    }
    ...
    private void lambda$new$2() {
        try {
            Umbra.debugLog("LEGIT-SWITCH: click received, activeStack=" + ClientSettings.INSTANCE.getActiveStack().getClass().getSimpleName());
            this.K.setText("");
            this.K$src$V$10w6uwu();
            ...
            Umbra.debugLog("LEGIT-SWITCH: switched to " + ClientSettings.INSTANCE.getActiveStack().getClass().getSimpleName());
        }
        catch (Throwable throwable) {
            Umbra.logThrowable((Throwable)throwable);
        }
    }
}
