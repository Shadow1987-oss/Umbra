...
import gg.umbra.ui.click.frame.FrameHeaderCloseToggleClickHandler;
...
extends FrameHeaderComponent {
    ...
    public void H() {
        ...
        this.R.setOverrideColor(this.w$src$Lgg_umbra_ui_click_frame_Frame_$y4htd0().y$src$Z$1f55jvh() ? CloseableFrameHeaderComponent.J.f : null);
