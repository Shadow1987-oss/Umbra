...
extends Frame {
    ...
    private static void lambda$getLegitModuleOverlays$2(HackManager modManager, HudModule hudModule, Class clazz) {
        Object obj = modManager.getMod(hudModule.getClass());
        if (obj != null) {
            ((HackModule)obj).toggle();
            Object t = ClientSettings.getFrame(clazz);
            if (t != null) {
                ((Frame)t).setVisible(((HackModule)obj).isEnabled());
            }
        }
    }
    ...
    private static List<HudOverlayEntrySpec> getHudModuleEntries() {
        ...
        try {
            ...
            for (HackModule mod : new ArrayList<HackModule>(modManager.getActiveModuleList())) {
                Class clazz;
                HudModule hudModule;
    ...
    private static boolean lambda$getLegitModuleOverlays$1(HackManager modManager, HudModule hudModule) {
