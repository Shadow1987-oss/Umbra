...
import gg.umbra.ui.click.frame.impl.profile.ProfileSnapshotModuleDetailsPanel;
import gg.umbra.ui.click.frame.impl.profile.ProfileSnapshotModuleListPanel;
...
extends Frame {
    ...
    public ProfileSnapshotFrame() {
        ...
        this.detailsContainer.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
    ...
    private void applyChanges() {
        ...
        Profile profile = Umbra.INSTANCE.getProfilesManager().getActiveProfileOrNull();
        if (this.snapshot.getProfile() != null && this.snapshot.getProfile().equals(profile)) {
            Umbra.INSTANCE.getProfilesManager().setActiveProfile(this.snapshot.getProfile());
        }
    }
    ...
    private void showCloseConfirmation() {
        ConfirmationDialogComponent.show(this.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa(), "Do you want to apply changes to profile?", "Apply", null, this::applyChangesAndClose, 80.0, "Discard", this::discardChangesAndClose);
    }
