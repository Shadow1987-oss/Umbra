...
extends GuiComponent {
    ...
    private HashMap<HackModule, TextGuiModuleRenderState> O;
    private TextGuiSettingsFrame v;
    private List<HackModule> R;
    public SmoothFontRenderer b;
    private TextGuiSettings i = Umbra.INSTANCE.getHackManager().getMod(TextGuiSettings.class);
    private double G = 110.0;
    private HashSet<HackModule> I;
    private TimerUtil Q;
    private double o = 0.0;
    private final Comparator<HackModule> BY;
    private HashMap<HackModule, Double> a = new HashMap();
    ...
    private Color R(HackModule mod) {
    ...
    private void l(List<HackModule> list) {
        TextGuiModuleRenderState textGuiModuleRenderState;
        ArrayList<HackModule> arrayList = new ArrayList<HackModule>();
        ArrayList<HackModule> arrayList2 = new ArrayList<HackModule>();
        for (HackModule mod : list) {
            if (this.R.contains(mod)) continue;
            arrayList.add(mod);
        }
        for (HackModule mod : this.R) {
        ...
        this.Q.reset();
        for (HackModule mod : this.O.keySet()) {
    ...
    public TextGuiOverlayComponent(TextGuiSettingsFrame textGuiSettingsFrame) {
        this.I = new HashSet();
        this.O = new HashMap();
        this.R = new ArrayList<HackModule>();
    ...
    private void f(List<HackModule> list) {
    ...
    private SmoothFontRenderer w(int n) {
        FontFamily fontFamily = Umbra.INSTANCE.getFontSelector().W().b();
        if (fontFamily != null && fontFamily != FontFamily.PROXIMA) {
            return Umbra.INSTANCE.getFontManager().n(fontFamily, n, false);
        }
        return Umbra.INSTANCE.getFontManager().a(n);
    }
    ...
    private void L(boolean bl) {
        ...
        double d = Umbra.INSTANCE.getClientSettings().getGuiScaleFactor();
        ...
        float f3 = this.v.isManagedByClickGui() ? (float)this.n() : (bl ? (float)(this.n() - this.v.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L()) : (float)(this.n() + 4.0));
        float f4 = f3;
        double d2 = this.v.A();
        boolean bl3 = bl2 = this.G$src$D$1b2f02a() + d2 / 2.0 >= (double)(Minecraft.J() / 4) / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor();
        if (bl2) {
            float f5;
            Object object2;
            int n3;
            boolean bl4 = Umbra.INSTANCE.getClientSettings().guiColor.isRainbowEnabled();
            double d3 = 10.0;
            CopyOnWriteArrayList<HackModule> copyOnWriteArrayList = new CopyOnWriteArrayList<HackModule>();
            for (HackModule object5 : Umbra.INSTANCE.getHackManager().collectMods()) {
            ...
            for (HackModule object7 : this.O.keySet()) {
            ...
            if (this.i.addCustomText.getEffectiveValue().booleanValue() && ((String)this.i.customText.getValue()).length() > 0) {
                ...
                SmoothFontRenderer smoothFontRenderer3 = Umbra.INSTANCE.getFontManager().n(FontFamily.PROXIMA, (int)(22.0f * f2), true);
            ...
            if (this.i.watermark.getEffectiveValue().booleanValue()) {
                ...
                ImageRenderer.drawImage((Color)object2, f6, f3, "umbralogo", f8, f8, bl6);
                ImageRenderer.drawImage(this.v.applyDefaultEditorAlpha(Color.WHITE), f7, f3, "v4", f8, f8, bl6);
                f3 += 15.0f * f2;
            }
            if (this.i.addCustomText.getEffectiveValue().booleanValue() && ((String)this.i.customText.getValue()).length() > 0) {
                String string = ((String)this.i.customText.getValue()).replace("&", "\u00a7");
                SmoothFontRenderer smoothFontRenderer4 = Umbra.INSTANCE.getFontManager().n(FontFamily.PROXIMA, (int)(22.0f * f2), true);
                ...
                if (this.i.shadow.getEffectiveValue().booleanValue()) {
                    smoothFontRenderer4.V(string, f5, f3, this.v.applyDefaultEditorAlpha(this.i.customTextColorEnabled.getEffectiveValue() != false && !Umbra.INSTANCE.getClientSettings().guiColor.isRainbowEnabled() ? this.i.customTextColor.getMutableColor() : J.z()), this.q$src$Z$emgut());
                } else {
                    smoothFontRenderer4.E(string, f5, f3, this.v.applyDefaultEditorAlpha(this.i.customTextColorEnabled.getEffectiveValue() != false && !Umbra.INSTANCE.getClientSettings().guiColor.isRainbowEnabled() ? this.i.customTextColor.getMutableColor() : J.z()), this.q$src$Z$emgut());
                }
            ...
            for (int i = 0; i < n3; ++i) {
                ...
                String string3;
                HackModule mod;
                HackModule mod2 = mod = bl5 ? null : (HackModule)arrayList.get(i);
                if (bl5) {
                ...
                if (i > 0) {
                    if (bl5) {
                        ...
                        HackModule mod3 = (HackModule)arrayList.get(i - 1);
                ...
                if (i < n3 - 1) {
                    if (bl5) {
                        ...
                        HackModule mod4 = (HackModule)arrayList.get(i + 1);
                ...
                if (i > 0) {
                    if (bl5) {
                        ...
                        HackModule mod5 = (HackModule)arrayList.get(i - 1);
        ...
        boolean bl20 = Umbra.INSTANCE.getClientSettings().guiColor.isRainbowEnabled();
        double d56 = 10.0;
        CopyOnWriteArrayList<HackModule> copyOnWriteArrayList = new CopyOnWriteArrayList<HackModule>();
        for (HackModule mod : Umbra.INSTANCE.getHackManager().collectMods()) {
            if (!mod.isEnabled() || mod.getGuiColor() == 0 || !mod.q$src$Z$12h8h4c() || this.i.hideModules.getEffectiveValue().booleanValue() && this.i.hiddenModules.matches(mod.getName(), false)) continue;
        ...
        if (this.i.addCustomText.getEffectiveValue().booleanValue() && ((String)this.i.customText.getValue()).length() > 0) {
            String string = ((String)this.i.customText.getValue()).replace("&", "\u00a7");
            SmoothFontRenderer smoothFontRenderer5 = Umbra.INSTANCE.getFontManager().n(FontFamily.PROXIMA, (int)(22.0f * f2), true);
        ...
        if (this.i.watermark.getEffectiveValue().booleanValue()) {
            ...
            ImageRenderer.drawImage((Color)object, f30, f3, "umbralogo", f32, f32, bl22);
            ImageRenderer.drawImage(this.v.applyDefaultEditorAlpha(Color.WHITE), f31, f3, "v4", f32, f32, bl22);
            f3 += 15.0f * f2;
        }
        if (this.i.addCustomText.getEffectiveValue().booleanValue() && ((String)this.i.customText.getValue()).length() > 0) {
            String string = ((String)this.i.customText.getValue()).replace("&", "\u00a7");
            SmoothFontRenderer smoothFontRenderer6 = Umbra.INSTANCE.getFontManager().n(FontFamily.PROXIMA, (int)(22.0f * f2), true);
            double d60 = smoothFontRenderer6.Y(string, this.q$src$Z$emgut());
            f = (float)(this.G$src$D$1b2f02a() + 2.0);
            if (this.i.shadow.getEffectiveValue().booleanValue()) {
                smoothFontRenderer6.V(string, f, f3, this.v.applyDefaultEditorAlpha(this.i.customTextColorEnabled.getEffectiveValue() != false && !Umbra.INSTANCE.getClientSettings().guiColor.isRainbowEnabled() ? this.i.customTextColor.getMutableColor() : J.z()), this.q$src$Z$emgut());
            } else {
                smoothFontRenderer6.E(string, f, f3, this.v.applyDefaultEditorAlpha(this.i.customTextColorEnabled.getEffectiveValue() != false && !Umbra.INSTANCE.getClientSettings().guiColor.isRainbowEnabled() ? this.i.customTextColor.getMutableColor() : J.z()), this.q$src$Z$emgut());
            }
        ...
        for (int i = 0; i < n; ++i) {
            ...
            String string5;
            HackModule mod;
            HackModule mod6 = mod = bl21 ? null : (HackModule)arrayList.get(i);
            if (bl21) {
            ...
            if (i > 0) {
                if (bl21) {
                    ...
                    double d67;
                    HackModule mod7 = (HackModule)arrayList.get(i - 1);
            ...
            if (i < n - 1) {
                if (bl21) {
                    ...
                    HackModule mod8 = (HackModule)arrayList.get(i + 1);
            ...
            if (i > 0) {
                if (bl21) {
                    ...
                    double d74;
                    double d75;
                    HackModule mod9 = (HackModule)arrayList.get(i - 1);
    ...
    private double o(int n) {
        ...
        if (this.i.addCustomText.getEffectiveValue().booleanValue() && ((String)this.i.customText.getValue()).length() > 0) {
            String string = ((String)this.i.customText.getValue()).replace("&", "\u00a7");
            SmoothFontRenderer smoothFontRenderer2 = Umbra.INSTANCE.getFontManager().n(FontFamily.PROXIMA, (int)(22.0f * f), true);
