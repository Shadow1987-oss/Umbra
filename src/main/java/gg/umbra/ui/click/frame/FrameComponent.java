...
import gg.umbra.wrapper.impl.Util;
...
extends GuiComponent {
    ...
    public void T(double d) {
        for (GuiComponent guiComponent : this.f()) {
            ...
            guiComponent.S(this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().m().get(guiComponent).W() + d);
        }
    }

    public RectData s$src$Lgg_umbra_utils_RectData_$1a7j2ql() {
        return this.NH;
    }
    ...
    public void H(boolean bl) {
        ...
        this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().L();
        this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().p();
        this.D$src$V$htqy5s();
        if (this.NS) {
    ...
    public ComponentLayout l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij() {
        return this.NI;
    }
    ...
    private void D$src$V$htqy5s() {
        this.NS = this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y() >= this.K && this.NU;
    }
    ...
    private void G$src$V$hvebxv() {
        ...
        double d = this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y();
    ...
    public FrameHeaderComponent j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() {
        return this.N5;
    }
    ...
    public RectData N$src$Lgg_umbra_utils_RectData_$1o0utwi() {
        return this.No;
    }
    ...
    public void b(double d) {
        double d2 = this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y();
        if (this.NK) {
            if (d < 0.0) {
                d = 0.0;
            }
        ...
        for (GuiComponent guiComponent : this.f()) {
            if (guiComponent instanceof FrameHeaderComponent) continue;
            double d3 = this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().m().get(guiComponent).W();
            double d4 = d3 + d;
            guiComponent.S(d4);
        }
        this.z$src$V$infu7a();
    ...
    public void z(boolean bl) {
        ...
        GuiRenderPrimitives.p(this.G$src$D$1b2f02a(), this.n(), this.A(), bl ? this.K + d : this.getComponentHeight() + d, this.getDisabledOverlayColor(), this.Q && this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() != null, 1.5f, 1.0f, 8.0f, FrameComponent.J.u, this.NZ);
    }
    ...
    private boolean M$src$Z$hyp3lh() {
        double d = this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y() - this.K;
        if (d <= 0.0) {
            return false;
        }
        double d2 = 0.001;
        ...
        try {
            ...
            if (this.NS) {
                ...
                if (this.NK) {
                    ...
                    d3 = this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y();
                    ...
                    d4 = this.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y();
