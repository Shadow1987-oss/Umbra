...
import gg.umbra.ui.click.animation.Animation;
...
extends GuiComponent {
    ...
    static {
        ENABLED_BACKGROUND_END = new Color(42, 44, 50);
    ...
    public ClickGuiModuleCardComponent(HackModule mod, double d) {
        this.getClass();
    ...
    public void H() {
        ...
        GuiRenderPrimitives.B(d5 += d10, d6, d7, d8, this.r(color4), 4.0f);
        Color color5 = this.hoverAnimation.getInterpolatedColor();
        if (color5.getAlpha() > 0) {
            GuiRenderPrimitives.B(d5, d6, d7, d8, this.r(color5), 4.0f);
        }
        ...
        GuiRenderPrimitives.B(d5 + 1.0, d6 + 2.0, 2.0, d8 - 4.0, this.r(color3), 1.0f);
        MousePosition mousePosition = RenderUtils.h();
        ...
        if (!this.reordering) {
            ...
            GuiRenderPrimitives.V((float)d18, (float)d19, 4.0, (float)(0.8 / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor()), color9);
        }
    ...
    public ClickGuiModuleCardComponent(HackModule mod) {
        this(mod, 22.0);
    }
