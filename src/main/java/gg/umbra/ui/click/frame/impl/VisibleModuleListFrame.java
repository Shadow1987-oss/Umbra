...
extends ModuleCategoryFrame {
    ...
    public static VisibleModuleListFrame U$src$Lgg_umbra_ui_click_frame_impl_VisibleModuleListFr$168oq2s() {
        return U2;
    }
    ...
    public static void e() {
        ...
        try {
            CopyOnWriteArrayList<HackModule> copyOnWriteArrayList = new CopyOnWriteArrayList<HackModule>(Umbra.INSTANCE.getModuleProfileMetadataCodec().getSelectedModules());
    ...
    public static ModuleComponent A(HackModule mod) {
