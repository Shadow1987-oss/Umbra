...
import gg.umbra.ui.click.frame.impl.ClientSettingsActionButtonRowComponent;
import gg.umbra.ui.click.frame.impl.ClientSettingsComponentFactory;
import gg.umbra.ui.click.frame.impl.ClientSettingsFrameActionClickHandler;
import gg.umbra.ui.click.frame.impl.ClientSettingsFrameOpenSearchAndCloseSettingsClickHandler;
import gg.umbra.ui.click.frame.impl.ClientSettingsFrameOpenSearchClickHandler;
import gg.umbra.ui.click.frame.impl.ClientSettingsFrameResetGuiLayoutClickHandler;
import gg.umbra.ui.click.frame.impl.ClientSettingsFrameSectionLabelComponent;
import gg.umbra.ui.click.frame.impl.ClientSettingsFrameSectionOpenClickHandler;
import gg.umbra.ui.click.frame.impl.ClientSettingsFrameSortGuiClickHandler;
...
extends Frame {
    private gg.umbra.config.ClientSettings r1;
    private ClientSettingsColorPickerEditorComponent rV;
    ...
    public void z(boolean bl) {
        super.z(bl);
        this.Y(238.0);
        GuiRenderPrimitives.C(this.G$src$D$1b2f02a(), this.n() + this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L() + 2.0, this.A(), this.L() - (this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L() + 8.0), ClientSettingsFrame.J.i);
        SmoothFontRenderer smoothFontRenderer = Umbra.INSTANCE.getFontManager().E(0.7, false);
        String string = "Umbra 1.0";
    ...
    public ClientSettingsFrame() {
        this.r1 = Umbra.INSTANCE.getClientSettings();
        this.rh = Umbra.INSTANCE.getPublicProfileSettings();
        this.r2 = new HashMap();
        ...
        for (GuiComponent guiComponent : list) {
            if (guiComponent instanceof ClientSettingsColorPickerEditorComponent) {
                this.rV = (ClientSettingsColorPickerEditorComponent)guiComponent;
            }
