...
import gg.umbra.ui.click.component.TruncatedTextComponent;
import gg.umbra.ui.click.component.layout.PaddedComponent;
import gg.umbra.ui.click.frame.impl.target.TargetInfoCombatStatStripComponent;
import gg.umbra.ui.click.frame.impl.target.TargetInfoDistanceStatStripComponent;
import gg.umbra.ui.click.frame.impl.target.TargetInfoEntityPreviewComponent;
import gg.umbra.ui.click.frame.impl.target.TargetInfoHealthBarComponent;
import gg.umbra.ui.click.frame.impl.target.TargetInfoLiveEntityPreviewComponent;
import gg.umbra.ui.click.frame.impl.target.TargetInfoPositiveStatStripComponent;
import gg.umbra.ui.click.frame.impl.target.TargetInfoPreviewHealthBarComponent;
import gg.umbra.ui.click.frame.impl.target.TargetInfoResettingCombatStatStripComponent;
...
implements EventListener {
    ...
    public TargetInfoPreviewComponent(TargetInfoSettingsFrame targetInfoSettingsFrame) {
        ...
        this.rootLayout = (FlowLayoutComponent)super.H$src$Lgg_umbra_ui_click_component_GuiComponent_$kfnvup();
        ...
        this.nameRow.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().Q(true);
        this.entityHeaderPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().Q(true);
    ...
    public void u() {
        ...
        if (this.settingsFrame.getSettings().showHovered.getEffectiveValue().booleanValue() && (rayTraceResult = Minecraft.p$src$Lgg_umbra_wrapper_impl_RayTraceResult_$5rw6n0()).isNotNull() && (entity = rayTraceResult.getEntity()).isNotNull() && entity.isInstance(MappedClasses.zm) && !entity.isInstance(MappedClasses.FT)) {
