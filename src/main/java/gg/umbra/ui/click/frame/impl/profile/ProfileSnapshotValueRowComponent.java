...
extends GuiComponent {
    ...
    public void H() {
        ...
        if (this.valueSnapshot.getSourceValue() instanceof ToggleSetting) {
            if (((Boolean)this.valueSnapshot.getValue()).booleanValue()) {
                this.valueLabel.setText("ON");
            } else {
                this.valueLabel.setText("OFF");
            }
        } else if (this.valueSnapshot.getSourceValue() instanceof RandomRangeSetting) {
            RandomRangeSetting randomValue = (RandomRangeSetting)this.valueSnapshot.getSourceValue();
        ...
        } else if (this.valueSnapshot.getSourceValue() instanceof SliderSetting) {
            SliderSetting numberValue = (SliderSetting)this.valueSnapshot.getSourceValue();
        ...
        } else if (this.valueSnapshot.getSourceValue() instanceof OptionSetting) {
            ...
            List<ToggleSetting> filterValues = entityTargetFilterValue.getFilterValues();
        ...
        } else if (this.valueSnapshot.getSourceValue() instanceof ColorPicker) {
        ...
        if (this.valueSnapshot.getSourceValue() instanceof ColorPicker) {
