...
extends InteractiveComponent {
    ...
    public ModuleComponent(ModuleCategoryFrame categoryFrame, HackModule module, double fontScale) {
    ...
    public ModuleComponent(ModuleCategoryFrame moduleCategoryFrame, HackModule mod) {
        this(moduleCategoryFrame, mod, 0.9);
    }

    private void repositionModuleRows(int targetIndex) {
        double firstRowY = this.categoryFrame.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().n() + this.categoryFrame.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L();
    ...
    public void H() {
        ...
        if (showNewBadge && !showingBindStatus) {
            ...
            SmoothFontRenderer badgeFontRenderer = Umbra.INSTANCE.getFontManager().W(0.8, false);
    ...
    private void updateDragOrder() {
        if (!MouseInput.isButtonDown(MouseButton.LEFT_CLICK.ordinal())) {
            ...
            if (this.pendingOrderIndex != -1) {
                Umbra.INSTANCE.getModuleProfileMetadataCodec().getSelectedModules().remove(this.module);
                Umbra.INSTANCE.getModuleProfileMetadataCodec().getSelectedModules().add(this.pendingOrderIndex, this.module);
            }
    ...
    private void updateDragPosition() {
        ...
        if (this.n() < this.categoryFrame.n() + this.categoryFrame.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L()) {
            if (this.categoryFrame.k$src$Z$if6xeb()) {
                this.categoryFrame.b(this.categoryFrame.J$src$D$hx1pag() + 1.0);
            }
            this.S(this.categoryFrame.n() + this.categoryFrame.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().L());
    ...
    public void buildValueComponents() {
        ...
        if (this.module instanceof BlockFinder) {
