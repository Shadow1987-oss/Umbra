package gg.umbra.ui.click.component.layout;
...
extends FrameComponent {
    ...
    public FrameComponent z$src$Lgg_umbra_ui_click_frame_FrameComponent_$s47o9d() {
        return this.contentPanel;
    }

    @Override
    public double x() {
        return this.contentPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C() + this.rightPadding;
    }
    ...
    public GuiComponent H$src$Lgg_umbra_ui_click_component_GuiComponent_$kfnvup() {
        return this.content;
    }

    @Override
    public double C() {
        this.contentPanel.Y(this.contentPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y());
        this.contentPanel.o(this.contentPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().C());
