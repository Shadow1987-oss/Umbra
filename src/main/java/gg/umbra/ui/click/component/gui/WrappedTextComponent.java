package gg.umbra.ui.click.component.gui;
...
extends SimpleTextLabelComponent {
    ...
    private void renderWrappedLines() {
        SmoothFontRenderer fontRenderer = this.bold ? Umbra.INSTANCE.getFontManager().W(this.fontScale, false) : Umbra.INSTANCE.getFontManager().E(this.fontScale, false);
