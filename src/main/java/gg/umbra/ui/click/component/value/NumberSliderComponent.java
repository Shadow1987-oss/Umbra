...
import gg.umbra.ui.click.component.value.NumberSliderInputHandle;
...
extends SliderComponentBase {
    ...
    private SliderSetting numberValue;
    private double minimum;

    public SliderSetting getSliderSetting() {
    ...
    private void handleValueChanged(SliderSetting changedValue) {
    ...
    public void H() {
        ...
        GuiRenderPrimitives.Y((float)(handleCenterX - handleSize / 2.0), (float)(trackCenterY + 0.5 - handleSize / 2.0), (float)handleSize, (float)(0.8 / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor()), J.z(), 0.0, this.getDisabledOverlayColor());
    }

    public NumberSliderComponent(SliderSetting numberValue) {
