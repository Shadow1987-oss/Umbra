...
import gg.umbra.ui.click.component.value.SearchBlockListOpenClickListener;
import gg.umbra.ui.click.component.value.SearchBlockRemoveClickListener;
...
extends AbstractListValueComponent {
    ...
    SearchManager searchManager = Umbra.INSTANCE.getSearch();
    ...
    private void openEditor() {
        Frame frame;
        if (this.mode == ValueComponentMode.STANDALONE && this.getParentFrameComponent() != null && (frame = this.getParentFrameComponent().L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa()) instanceof ClickGuiMainFrame) {
