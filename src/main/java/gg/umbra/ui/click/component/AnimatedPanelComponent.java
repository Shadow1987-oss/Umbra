...
extends PanelComponent {
    ...
    public void z(boolean useAlternateHeight) {
        ...
        GuiRenderPrimitives.e(this.G$src$D$1b2f02a(), this.n(), this.A(), useAlternateHeight ? this.K : this.L(), this.useStaticBorderColor ? AnimatedPanelComponent.J.K : this.borderAnimation.getInterpolatedColor(), this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() != null, 2.0f, 1.0f);
    }
