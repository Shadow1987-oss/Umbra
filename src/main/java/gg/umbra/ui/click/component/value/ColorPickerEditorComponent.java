...
import gg.umbra.ui.click.component.value.ColorPickerEditorToggleExpandedClickHandler;
...
public class ColorPickerEditorComponent
extends GuiComponent {
    ...
    public ColorPickerEditorComponent(ColorPicker colorValue) {
        ...
        this.saturationSlider.setDisabledOverlayColor(ColorPickerEditorComponent.J.r);
        this.vibranceSlider.setDisabledOverlayColor(ColorPickerEditorComponent.J.r);
        this.opacitySlider.setDisabledOverlayColor(ColorPickerEditorComponent.J.r);
        this.saturationSlider.setToolTips(null);
        this.vibranceSlider.setToolTips(null);
        this.opacitySlider.setToolTips(null);
        this.collapseButton.addClickListener(new ColorPickerEditorToggleExpandedClickHandler(this));
    ...
    static {
        ColorPickerEditorComponent.setLegacyInteractionMarker(null);
    }
    ...
    public static boolean setCollapsedCompat(ColorPickerEditorComponent editor, boolean collapsed) {
        editor.collapsed = collapsed;
        return editor.collapsed;
    }

    public static boolean isCollapsedCompat(ColorPickerEditorComponent editor) {
        return editor.collapsed;
    }
