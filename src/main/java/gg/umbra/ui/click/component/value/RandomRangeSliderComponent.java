...
import gg.umbra.ui.click.component.value.RandomRangeSliderInputHandle;
...
extends SliderComponentBase {
    ...
    private RandomRangeSetting randomValue;
    ...
    public RandomRangeSliderComponent(RandomRangeSetting randomValue) {
    ...
    private void handleValueChanged(RandomRangeSetting changedValue) {
    ...
    public RandomRangeSetting getRandomRangeSetting() {
