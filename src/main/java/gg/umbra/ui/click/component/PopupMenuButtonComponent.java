...
import gg.umbra.ui.click.component.gui.InteractivePopupOutsideCloseMouseListener;
...
extends InteractiveComponent {
    ...
    public PopupMenuButtonComponent(String label, List<GuiComponent> menuItems, Color baseBackgroundColor, Color hoverBackgroundColor, Color borderColor, float borderRadius, float borderAlpha) {
        ...
        this.menuPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
    ...
    public void togglePopup() {
        ...
        if (popupFrame != null) {
            ...
            this.menuPanel.setExplicitHeight(Math.min(this.menuPanel.d$src$D$ibccpu(), this.menuPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y()));
