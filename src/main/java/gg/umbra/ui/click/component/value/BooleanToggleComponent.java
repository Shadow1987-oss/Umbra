...
import gg.umbra.ui.click.animation.ThemeColorAnimation;
import gg.umbra.ui.click.component.GuiComponent;
import gg.umbra.ui.click.component.PanelComponent;
import gg.umbra.ui.click.component.value.BooleanStateAdapter;
import gg.umbra.ui.click.component.value.BooleanToggleComponentClickMouseListener;
import gg.umbra.ui.click.component.value.CompactListValueComponent;
...
implements BooleanStateAdapter<BooleanToggleComponent> {
    ...
    private final ToggleSetting booleanValue;
    ...
    private boolean hasSingleListChildInMainGui() {
        if (!(this.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa() instanceof ClickGuiMainFrame) || this.booleanValue == null) {
            return false;
        }
    ...
    public void c() {
        ...
        GuiRenderPrimitives.V((float)switchX + 1.0f + (float)this.knobPositionAnimation.getInterpolatedValue().doubleValue(), (float)switchY + 1.0f, 4.0, (float)(0.8 / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor()), BooleanToggleComponent.J.i);
    ...
    public ToggleSetting getToggleSetting() {
    ...
    public BooleanToggleComponent(String label, double fontScale, ToggleSetting booleanValue) {
        super(0.0, 0.0);
    ...
    private List<String> getWrappedLabelLines() {
        ...
        SmoothFontRenderer fontRenderer = this.getFontRenderer(this.fontScale);
        String sanitizedLabel = Umbra.INSTANCE.getFontSelector().W().s(this.getLabel());
    ...
    public BooleanToggleComponent(ToggleSetting booleanValue) {
