...
extends FrameComponent {
    ...
    public void z(boolean useViewportHeight) {
        ...
        if (this.shadowEnabled && this.u$src$I$ikouxa() > 0) {
            GuiRenderPrimitives.p(renderX, renderY, renderWidth, renderHeight, backgroundColor, this.j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() != null, this.cornerRadius, 1.0f, 8.0f, PanelComponent.J.u, this.u$src$I$ikouxa());
