...
import gg.umbra.ui.click.component.value.StringMapEntryListFrame;
import gg.umbra.ui.click.component.value.StringMapEntryRemoveHandler;
import gg.umbra.ui.click.component.value.StringMapKeyInputComponent;
import gg.umbra.ui.click.component.value.StringMapValueInputComponent;
...
extends GuiComponent {
    ...
    public void H() {
        ...
        this.entriesFrame.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
        this.entriesFrame.N(true);
        this.entriesFrame.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M(false);
        this.entriesFrame.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().I(false);
