...
import gg.umbra.ui.click.component.DropdownPopupCloseClickHandler;
import gg.umbra.ui.click.component.DropdownSelectOptionComponent;
import gg.umbra.ui.click.component.DropdownSelectionListener;
import gg.umbra.ui.click.component.FilledSpacerComponent;
import gg.umbra.ui.click.component.FocusableComponent;
import gg.umbra.ui.click.component.GuiComponent;
import gg.umbra.ui.click.component.ModeEntryTextFormatter;
...
implements FocusableComponent {
    @Nullable
    private OptionSetting modeValue;
    ...
    public void togglePopup() {
        ...
        synchronized (optionTextFormatter) {
            if (popupFrame != null) {
                ...
                this.optionsPanel.setExplicitHeight(Math.min(this.optionsPanel.d$src$D$ibccpu(), this.optionsPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().y()));
                this.optionsPanel.H(true);
    ...
    @SuppressWarnings("unchecked")
    public DropdownSelectComponent(OptionSetting modeValue) {
    ...
    public DropdownSelectComponent(String label, OptionTextFormatter<T> optionFormatter, List<T> options) {
        ...
        this.optionsPanel.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
