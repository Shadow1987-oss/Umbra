...
import gg.umbra.ui.click.component.GuiActivationListener;
...
import gg.umbra.ui.click.frame.FrameOutsideChildClickFilterMouseListener;
...
implements GuiComponentContract {
    ...
    public SmoothFontRenderer getAlternateFontRenderer(double scale) {
        return this.fontOption != null ? this.fontOption.k((float)scale, true) : Umbra.INSTANCE.getFontManager().W(scale, false);
    }
    ...
    public void J() {
        ...
        for (GuiComponent guiComponent : this.f()) {
            if (!guiComponent.V$src$Z$1xhop3l() || guiComponent.isChildRenderingSuppressed() || !guiComponent.t() || !ClientSettings.canReceiveInput(guiComponent) || this instanceof FrameComponent && ((FrameComponent)this).j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc() != null && ((FrameComponent)this).j$src$Lgg_umbra_ui_click_frame_FrameHeaderComponent_$175vsfc().t() && !(guiComponent instanceof FrameHeaderComponent)) continue;
            guiComponent.J();
    ...
    public SmoothFontRenderer getDefaultFontRenderer() {
        return this.fontOption != null ? this.fontOption.k(1.0f, false) : Umbra.INSTANCE.getFontManager().Y();
    }
    ...
    public SmoothFontRenderer getFontRenderer(double scale) {
        return this.fontOption != null ? this.fontOption.k((float)scale, false) : Umbra.INSTANCE.getFontManager().Y(scale);
    }
    ...
    public Frame L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa() {
        if (this.parentHeader != null) {
            return this.parentHeader.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa();
        }
        ...
        if (frameComponent != null) {
            ...
            return frameComponent.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa();
        }
        if (frameComponent instanceof Frame) {
            return (Frame)frameComponent;
        }
