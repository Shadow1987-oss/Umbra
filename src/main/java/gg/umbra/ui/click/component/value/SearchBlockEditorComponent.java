...
import gg.umbra.ui.click.component.value.SearchBlockEditorEnabledSyncMouseListener;
import gg.umbra.ui.click.component.value.SearchBlockEditorMouseListener;
...
extends GuiComponent {
    ...
    private final ToggleSetting enabledValue = ToggleSetting.create(null, "", false);
    ...
    private final ToggleSetting tracersValue;
    ...
    public SearchBlockEditorComponent(SearchBlock searchBlock) {
        this.tracersValue = ToggleSetting.create(null, "DirectionLines", false);
        ...
        this.colorValue = ColorPicker.create(null, searchBlock.d(), searchBlock.B());
    ...
    public static ToggleSetting getTracersValueCompat(SearchBlockEditorComponent component) {
    ...
    public static ToggleSetting getEnabledValueCompat(SearchBlockEditorComponent component) {
