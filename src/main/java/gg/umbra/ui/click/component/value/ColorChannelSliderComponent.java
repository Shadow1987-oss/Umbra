...
import gg.umbra.ui.click.component.value.ColorPaletteRefreshClickListener;
...
extends SliderComponentBase {
    ...
    private void handleColorPickerChanged(ColorPicker changedValue) {
    ...
    public void H() {
        ...
        GuiRenderPrimitives.Y((float)(this.handleBounds.o() + this.handleBounds.e() / 2.0 - handleSize / 2.0), (float)(this.handleBounds.W() + this.handleBounds.R() / 2.0 - handleSize / 2.0), (float)handleSize, (float)(0.8 / Umbra.INSTANCE.getClientSettings().getGuiScaleFactor()), ColorChannelSliderComponent.J.A, 0.0, null);
    }

    public ColorChannelSliderComponent(ColorChannelType channelType, ColorPicker colorValue) {
        this(channelType, colorValue, colorValue.getName(), 1.0);
        this.bindValue(colorValue);
        colorValue.addChangeListener(this::handleColorPickerChanged);
        this.synchronizeHandlePosition();
    }
    ...
    public ColorChannelSliderComponent(ColorChannelType channelType, ColorPicker colorValue, String label, double step) {
        super(label);
    ...
    public ColorChannelSliderComponent(ColorPaletteSliderComponent paletteSlider) {
        this(ColorChannelType.BLOCK_CHILD, paletteSlider.getColorPicker());
    ...
    public void g(GuiMouseEvent mouseEvent) {
        ...
        String legacyInteractionMarker = ColorPickerEditorComponent.getLegacyInteractionMarker();
