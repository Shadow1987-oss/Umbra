...
import gg.umbra.ui.click.component.CenteredGlyphComponent;
...
import gg.umbra.ui.click.component.PopupSelectorComponent;
...
extends PopupSelectorComponent {
    ...
    public ProfileSelectionPopupComponent(String label, @Nullable Profile selectedProfile, Profile ... profiles) {
        ...
        this.popupContent.l$src$Lgg_umbra_ui_click_layout_ComponentLayout_$di1tij().M("wrap");
    ...
    private void requestProfileSelectionConfirmation(Profile profile) {
        ConfirmationDialogComponent.show(this.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa(), "Are you sure you want to change the derived profile?\n \nProfile settings will be swapped to other profile", "Confirm", "newtrash", () -> this.selectProfile(profile), 100.0, null, null);
    }
