...
import gg.umbra.ui.click.component.value.ListValueDropdownCloseClickHandler;
...
extends FloatingValueDropdownLayer<ListValueComponent> {
    ...
    public void u() {
        ...
        if (listValueComponent != null && (frameComponent = listValueComponent.getParentFrameComponent()).equals(frame = frameComponent.L$src$Lgg_umbra_ui_click_frame_Frame_$1djx6sa()) && !frame.f().contains(listValueComponent)) {
