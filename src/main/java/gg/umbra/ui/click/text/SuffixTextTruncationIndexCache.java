...
import gg.umbra.ui.click.text.SuffixTextTruncationIndexLruCache;
import gg.umbra.ui.click.text.TruncatedTextSpec;
...
public class SuffixTextTruncationIndexCache {
    ...
    public int getTruncationIndex(TruncatedTextSpec textSpec) {
        ...
        SmoothFontRenderer fontRenderer = textSpec.isBold() ? Umbra.INSTANCE.getFontManager().W(textSpec.getFontScale(), false) : Umbra.INSTANCE.getFontManager().Y(textSpec.getFontScale());
