...
import gg.umbra.ui.font.FontFamilySwitchMap;
import gg.umbra.ui.font.LegacySmoothFontRenderer;
...
public class FontManager {
    ...
    public SmoothFontRenderer W(double d, boolean bl) {
        int n = (int)(16.0 * d);
        double d2 = Umbra.INSTANCE.getClientSettings().getGuiScaleFactor();
        n = (int)((double)n * d2);
    ...
    public void e() {
        ...
        this.w = Umbra.readResource(string);
        String string2 = "proximabd.ttf";
        this.J = Umbra.readResource(string2);
        String string3 = "noto.ttf";
        this.V = Umbra.readResource(string3);
        String string4 = "poppins_rg.ttf";
        this.I = Umbra.readResource(string4);
        this.X = true;
    }
